---
title: "PostgreSQL compatibility (removed)"
url: "https://ydb.tech/docs/en/postgresql/intro?version=v26.1"
doc_path: "en/postgresql/intro"
version: "v26.1"
lang: "en"
source_path: "en/core/postgresql/intro.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/postgresql/intro.md"
description: "Alert."
...
| --- | --- |
| psql, pgAdmin, or PostgreSQL drivers | [YDB CLI](../reference/ydb-cli/index.md), [Embedded UI](../reference/embedded-ui/index.md), [YDB SDK](../reference/ydb-sdk/index.md), or the [JDBC driver](https://github.com/ydb-platform/ydb-jdbc-driver) |
| PostgreSQL SQL syntax | [YQL](../yql/reference/index.md) — YDB's native SQL dialect |
...
If you need help migrating from PostgreSQL compatibility, discuss your case in [YDB Discord](https://discord.gg/R5MvZTESWc) or open an issue on [GitHub](https://github.com/ydb-platform/ydb/issues).
