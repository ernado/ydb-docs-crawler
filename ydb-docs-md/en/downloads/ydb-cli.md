---
title: "Download YDB CLI"
url: "https://ydb.tech/docs/en/downloads/ydb-cli?version=v26.1"
doc_path: "en/downloads/ydb-cli"
version: "v26.1"
lang: "en"
source_path: "en/core/downloads/ydb-cli.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/downloads/ydb-cli.md"
description: "YDB CLI ( ydb ) is a command-line utility for working with YDB databases. It is distributed under the Apache 2.0 license. Tip."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Download YDB CLI

[YDB CLI](../reference/ydb-cli/index.md) (`ydb`) is a command-line utility for working with YDB databases. It is distributed under the [Apache 2.0 license](https://github.com/ydb-platform/ydb/blob/main/LICENSE).

> [!TIP]
> The recommended way to install YDB CLI is by using the [installation script](../reference/ydb-cli/install.md). The script automatically downloads the appropriate binary and adds it to your `PATH`.
