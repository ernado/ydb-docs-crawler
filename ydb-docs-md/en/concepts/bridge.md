---
title: "Bridge cluster operation mode"
url: "https://ydb.tech/docs/en/concepts/bridge?version=v26.1"
doc_path: "en/concepts/bridge"
version: "v26.1"
lang: "en"
...
Data is stored in pairs of [storage groups](glossary.md#storage-group) from different piles. Within each pile, any YDB [operating mode](topology.md#cluster-config) supported for data storage may be used.
...
For more on how bridge mode works, see [Bridge mode](../contributor/bridge.md).
