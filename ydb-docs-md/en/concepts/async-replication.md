...
url: "https://ydb.tech/docs/en/concepts/async-replication?version=v26.1"
doc_path: "en/concepts/async-replication"
version: "v26.1"
lang: "en"
source_path: "en/core/concepts/async-replication.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/concepts/async-replication.md"
description: "Asynchronous replication allows for synchronizing data between YDB databases in near real time. It can also be used for data migration between databases with mi"
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Asynchronous Replication

Asynchronous replication allows for synchronizing data between YDB [databases](glossary.md#database) in near real time. It can also be used for data migration between databases with minimal downtime for applications interacting with these databases. Such databases can be located in the same YDB [cluster](glossary.md#cluster) as well as in different clusters.
...
- [Initialization](async-replication.md#init)
- [Initial table scan](async-replication.md#initial-scan)
- [Change data replication](async-replication.md#replication-of-changes)
...
Each change data block has its *creation time* (created_atcreated\\_atcreated_at). Consumers track the *reception time* of the change data (received_atreceived\\_atreceived_at). Thus, you can use the following formula to calculate the *replication lag*:
...
> [!WARNING]
> If asynchronous replication is dropped without prior [completion](async-replication.md#done) and replica objects are not deleted, they will remain available only for reading.
