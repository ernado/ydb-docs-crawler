...
url: "https://ydb.tech/docs/en/concepts/datamodel/external_table?version=v26.1"
doc_path: "en/concepts/datamodel/external_table"
version: "v26.1"
lang: "en"
...
More details on working with external tables describing S3 buckets (Object Storage) can be found in section [Reading Data from an External Table Pointing to S3 (Object Storage)](../query_execution/federated_query/s3/external_table.md).
