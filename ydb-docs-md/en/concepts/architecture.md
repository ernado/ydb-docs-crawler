---
title: "YDB Architecture Overview"
url: "https://ydb.tech/docs/en/concepts/architecture?version=v26.1"
doc_path: "en/concepts/architecture"
version: "v26.1"
lang: "en"
source_path: "en/core/concepts/architecture.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/concepts/architecture.md"
...
- [**Asynchronous replication**](async-replication.md): near real-time data synchronization between YDB databases — both within a single cluster and across different clusters.
...
- [**Federated queries**](query_execution/federated_query/index.md): execute queries against external data sources (e.g., S3) as part of YQL queries, without prior data import to YDB storage.
...
- **Tools, integrations, and APIs**: [YDB CLI](../reference/ydb-cli/index.md) for running queries, administration, and debugging. [SDKs](../reference/ydb-sdk/index.md) for C++, C#, Go, Java, JavaScript, PHP, Python, and Rust. Integrations with various third-party systems. Learn more in [Integrations YDB](../integrations/index.md) and [Languages and APIs](../reference/languages-and-apis/index.md).
...
The next level of detail of the overall YDB architecture is explained in the [General YDB schema](../contributor/general-schema.md) article.
