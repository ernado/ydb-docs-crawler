---
title: "Data transformation and preparation (ETL/ELT)"
url: "https://ydb.tech/docs/en/concepts/analytics/concepts/etl?version=v26.1"
doc_path: "en/concepts/analytics/concepts/etl"
version: "v26.1"
lang: "en"
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/concepts/analytics/concepts/_includes/ydb_vs_another.png)
...
Apache Spark is one of the most popular tools for such tasks, and a [dedicated connector](../../../integrations/query-engines/spark.md) to YDB has been developed for it. If your company uses other similar solutions (e.g., Apache Flink), they can also be used to build ETL processes using the [JDBC driver](../../../reference/languages-and-apis/jdbc-driver/index.md).
...
- Apache Airflow: an [Apache Airflow provider](../../../integrations/orchestration/airflow.md) is supported for orchestrating data in YDB. It can be used to create DAGs that run `dbt run`, execute YQL scripts, or initiate Spark jobs.
...
- other orchestrators: if your company uses a different tool (e.g., Dagster, Prefect) or a custom scheduler, you can use it to run the same commands. Most orchestrators can execute shell scripts, allowing you to call the YDB CLI, [dbt](etl.md#dbt) run, and other utilities.

## Integration with other ETL tools via JDBC

YDB provides a [JDBC driver](../../../reference/languages-and-apis/jdbc-driver/index.md), enabling the use of a wide range of existing ETL tools, such as [Apache NiFi](https://nifi.apache.org/) and other JDBC-compliant systems.
