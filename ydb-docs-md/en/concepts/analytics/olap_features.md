---
title: "Key Analytics Capabilities: Quick Reference"
url: "https://ydb.tech/docs/en/concepts/analytics/olap_features?version=v26.1"
doc_path: "en/concepts/analytics/olap_features"
version: "v26.1"
lang: "en"
...
## Data Warehouse Design (Concepts & Design) {#data-warehouse-design-concepts-and-design}
...
## Data Processing and Transformation (ETL/ELT) {#data-processing-and-transformation-etl/elt}
...
## Application Development & Integration (Development & SDKs) {#application-development-and-integration-development-and-sdks}

Tools for application developers.

- [YDB SDK Overview](../../reference/ydb-sdk/index.md): Native SDKs for Go, Python, Java, C++, JavaScript.
- [JDBC driver](../../reference/languages-and-apis/jdbc-driver/index.md): Standard connectivity for the Java ecosystem.
- [YDB CLI](../../reference/ydb-cli/index.md): Command-line tool for administration and query execution.
...
## Operations & Performance Management {#operations-and-performance-management}
