...
url: "https://ydb.tech/docs/en/devops/deployment-options/ansible/initial-deployment/deployment-preparation?version=v26.1"
doc_path: "en/devops/deployment-options/ansible/initial-deployment/deployment-preparation"
version: "v26.1"
lang: "en"
source_path: "en/core/devops/deployment-options/ansible/initial-deployment/deployment-preparation.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/devops/deployment-options/ansible/initial-deployment/deployment-preparation.md"
description: "Prerequisites Choose a topology for installation."
...
Before installing, choose a suitable YDB cluster topology — it determines the number of servers and disks required:

**To get started with YDB**, we recommend the `mirror-3dc-3-nodes` topology. It requires only 3 servers and 9 disks for user data — the simplest and fastest way to create a pilot cluster.
...
>
> See [YDB System Requirements and Recommendations](../../../concepts/system-requirements.md) for more details.

When using virtual machines from a public cloud provider, we recommend following [Deploy Infrastructure for YDB Cluster using Terraform](../preparing-vms-with-terraform.md).
...
If Ansible is already installed, you can go to the [Ansible project setup](deployment-preparation.md#ansible-project-setup) section. If Ansible is not installed yet, install it using one of the following methods:

<details>
<summary>Installing Ansible globally</summary>
...
<details>
<summary>Installing Ansible in a Python virtual environment</summary>
...
### Installing YDB Ansible playbooks
