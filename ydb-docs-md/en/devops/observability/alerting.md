---
title: "Alerting"
url: "https://ydb.tech/docs/en/devops/observability/alerting?version=v26.1"
doc_path: "en/devops/observability/alerting"
version: "v26.1"
lang: "en"
source_path: "en/core/devops/observability/alerting.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/devops/observability/alerting.md"
description: "Alerting is a mechanism for automatic notifications that informs administrators or DevOps engineers about events that require their attention or intervention."
...
This page describes configurable alerting rules and how they work in YDB.

## Alerting in YDB with Prometheus Alerting Rules {#prometheus-rules}
...
**Description:** This rule monitors [resource pool](../../concepts/glossary.md#resource-pool) utilization in YDB. It fires when utilization exceeds 90%, which can lead to performance degradation and higher query latency.  
 **What to do:** Analyze the load. The alert message includes the name of the pool where the threshold is exceeded. For diagnosing CPU-related issues, see [CPU bottleneck](../../troubleshooting/performance/hardware/cpu-bottleneck.md).
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/devops/_assets/prometheus_exec_pool.png)

### YDB Authentication Errors

**Description:** This rule tracks authentication errors in YDB. It fires when more than 2 errors occur within the `for` period. This may indicate incorrect credentials, security misconfiguration, or a system configuration issue.  
 **What to do:** Search [Logging in YDB](logging.md) for authentication errors and identify the cause.
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/devops/_assets/prometheus_ticket_errors.png)
 ...
 **What to do:** Determine why the database has grown beyond the expected size. Remove unneeded data (for example, old logs) or increase the database size limit if appropriate. For diagnosing disk space issues, see [Disk space](../../troubleshooting/performance/hardware/disk-space.md).

#### Warning Storage Usage (80%) {#warning-storage-usage-80percent}
...
#### Critical Storage Usage (90%) {#critical-storage-usage-90percent}
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/devops/_assets/prometheus_storage_usage_health_check.png)
