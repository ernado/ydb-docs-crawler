---
title: "YDB Versioning"
url: "https://ydb.tech/docs/en/devops/concepts/versioning?version=v26.1"
doc_path: "en/devops/concepts/versioning"
version: "v26.1"
lang: "en"
...
The list of available YDB releases is published on the [download page](../../downloads/index.md). The YDB release policy is described in detail in the [Manage YDB Releases](../../contributor/manage-releases.md) article in the documentation section for YDB developers.

## Version Compatibility

> [!NOTE]
> Previously, the YDB server version consisted of three numbers (for example, `v24.3.3`), starting with major version `25.1`. The fourth number was added to specify the patch number (for example, `v25.1.1.3`). For more details about changes in version naming, see [Manage YDB Releases](../../contributor/manage-releases.md).
