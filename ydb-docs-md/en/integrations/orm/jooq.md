---
title: "JOOQ extension for YDB"
url: "https://ydb.tech/docs/en/integrations/orm/jooq?version=v26.1"
doc_path: "en/integrations/orm/jooq"
version: "v26.1"
lang: "en"
source_path: "en/core/integrations/orm/jooq.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/integrations/orm/jooq.md"
description: "This guide explains how to use JOOQ with YDB."
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# JOOQ extension for YDB

This guide explains how to use [JOOQ](https://www.jooq.org/) with YDB.
...
You can generate Java classes using any of the tools provided on the [official JOOQ website](https://www.jooq.org/doc/latest/manual/code-generation/codegen-configuration/). Two dependencies are required: the [YDB JDBC driver](https://github.com/ydb-platform/ydb-jdbc-driver) and the JOOQ extension for YDB, along with two parameters:
...
In all other respects, the YDB dialect follows the [JOOQ documentation](https://www.jooq.org/doc/latest/manual/).
