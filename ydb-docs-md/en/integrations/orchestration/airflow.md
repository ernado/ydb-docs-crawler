...
url: "https://ydb.tech/docs/en/integrations/orchestration/airflow?version=v26.1"
doc_path: "en/integrations/orchestration/airflow"
version: "v26.1"
lang: "en"
...
- Operator [`YDBExecuteQueryOperator`](airflow.md#ydb_execute_query_operator) for integrating tasks into the Apache Airflow™ scheduler.
- Hook [`YDBHook`](airflow.md#ydb_hook) for direct interaction with YDB.
...
- `ydb_conn_id` — the connection identifier with the `YDB` type, containing the connection parameters for YDB. If omitted, a connection named [`ydb_default`](airflow.md#ydb_default) is used. The `ydb_default` connection is preinstalled as part of Apache Airflow™ and does not need to be configured separately.
...
#### Optional arguments {#optional-arguments1}
...
Performs [batch data insertion](../../recipes/ydb-sdk/bulk-upsert.md) into YDB tables.

#### Required arguments {#required-arguments1}
...
## Connection to YDB {#ydb_default}

To connect to YDB, you must create a new or edit an existing [Apache Airflow™ connection](https://airflow.apache.org/docs/apache-airflow/stable/howto/connection.html) with the `YDB` type.

![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/orchestration/_assets/ydb_connection.png)
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/orchestration/_assets/airflow_dag.png)

To execute queries in YDB, a pre-created connection of type [YDB Connection](https://airflow.apache.org/docs/apache-airflow-providers-ydb/stable/connections/ydb.html) named `test_ydb_connection` is used.
