---
title: "SQL dialect converter to YQL"
url: "https://ydb.tech/docs/en/integrations/sql-translation/sql-dialect-converter?version=v26.1"
doc_path: "en/integrations/sql-translation/sql-dialect-converter"
version: "v26.1"
lang: "en"
...
- DML operations: `INSERT`, `UPDATE`, `DELETE` (taking into account [transaction features of YDB](../../concepts/transactions.md)).
...
- **Dialect-specific DDL.** `CREATE TABLE` for complex types may require manual adjustment considering [columnar and row-based tables](../../concepts/datamodel/table.md) in YDB.
...
- [SQLGlot](sqlglot.md)
- [Connecting to YDB using the DBeaver plugin](../gui/dbeaver-plugin.md)
