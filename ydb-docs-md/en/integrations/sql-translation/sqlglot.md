---
title: "SQLGlot"
url: "https://ydb.tech/docs/en/integrations/sql-translation/sqlglot?version=v26.1"
doc_path: "en/integrations/sql-translation/sqlglot"
version: "v26.1"
lang: "en"
...
[ydb-sqlglot-plugin plugin](https://github.com/ydb-platform/ydb-sqlglot-plugin) adds the YDB dialect to SQLGlot. After installation, SQLGlot can both parse [YQL](../../yql/reference/index.md) queries and generate YQL from queries written in other dialects. The conversion is bidirectional: any supported dialect ↔ YQL.
...
When migrating to YDB, the plugin automatically converts the original dialect constructs to YQL rules. For example, names with schema references (`schema.table`) are transformed into a [YDB path](../../concepts/datamodel/dir.md) with backticks:
...
- [SQL dialect converter to YQL](sql-dialect-converter.md)
