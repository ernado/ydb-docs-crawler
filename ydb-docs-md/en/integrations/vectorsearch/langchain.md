---
title: "LangChain"
url: "https://ydb.tech/docs/en/integrations/vectorsearch/langchain?version=v26.1"
doc_path: "en/integrations/vectorsearch/langchain"
version: "v26.1"
lang: "en"
source_path: "en/core/integrations/vectorsearch/langchain.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/integrations/vectorsearch/langchain.md"
description: "Integration of YDB with langchain enables the use of YDB as a vector store for RAG applications."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# LangChain

Integration of YDB with [langchain](https://python.langchain.com/docs/introduction/) enables the use of YDB as a [vector store](https://python.langchain.com/docs/concepts/vectorstores/) for [RAG](https://python.langchain.com/docs/concepts/rag/) applications.
...
- Local YDB
  ...
  For more information, see [Install and start YDB](../../quickstart.md#install).
