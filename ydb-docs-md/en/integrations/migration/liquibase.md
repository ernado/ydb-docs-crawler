---
title: "Migrating YDB data schemas with the Liquibase migration tool"
url: "https://ydb.tech/docs/en/integrations/migration/liquibase?version=v26.1"
doc_path: "en/integrations/migration/liquibase"
version: "v26.1"
lang: "en"
source_path: "en/core/integrations/migration/liquibase.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/integrations/migration/liquibase.md"
...
[Liquibase](https://www.liquibase.com/) is an open-source library for tracking, managing, and applying changes to database schemas. It is extended with dialects for different database management systems (DBMS), including YDB.
...
## Features of the YDB Dialect {#ydb-dialect}
...
Table of comparison of Liquibase types descriptions with [YDB types](../../yql/reference/types/primitive.md):
...
`loadData`, `loadUpdateData` - upload data from a `CSV` file into a table. `loadUpdateData` loads data using the [UPSERT INTO](../../yql/reference/syntax/upsert_into.md) command.
...
| `Timestamp` | The timestamp from the [ISO-8601](https://en.wikipedia.org/wiki/ISO_8601) standard corresponds to the `java.time.Instant` in Java, timezone will be set to `UTC` (precision in microseconds - `Timestamp` type YDB restriction) |
...
> [!WARNING]
> To understand which SQL statements YDB can perform and what are the restrictions on data types, read the documentation for the query language [YQL](../../yql/reference/index.md).
...
- Liquibase CLI
  ...
  First, you need to install Liquibase itself using [one of the recommended methods](https://docs.liquibase.com/start/install/home.html). Then you need to place the `.jar` archives of [YDB JDBC driver](https://github.com/ydb-platform/ydb-jdbc-driver/releases) and Liquibase [YDB dialect](https://mvnrepository.com/artifact/tech.ydb.dialects/liquibase-ydb-dialect/1.0.0) into the `internal/lib` folder.
...
![_assets/liquibase-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/liquibase-step-1.png)
...
![_assets/liquibase-step-2.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/liquibase-step-2.png)
...
![_assets/liquibase-step-3.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/liquibase-step-3.png)
...
![_assets/liquibase-step-4.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/liquibase-step-4.png)

## Connecting to YDB {#connect-to-ydb}
