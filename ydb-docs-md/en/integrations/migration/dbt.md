---
title: "Integration of dbt with YDB"
url: "https://ydb.tech/docs/en/integrations/migration/dbt?version=v26.1"
doc_path: "en/integrations/migration/dbt"
version: "v26.1"
lang: "en"
source_path: "en/core/integrations/migration/dbt.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/integrations/migration/dbt.md"
...
### Seeds (CSV-based reference/test data) {#seeds-csv-based-reference/test-data}
...
- Python 3.10+;
- dbt Core 1.8+;
- An existing YDB cluster (a single-node installation from the [quickstart](../../quickstart.md) is sufficient).
...
5. Inside your project directory, you will find the following structure:
   ...
   ![dbt-ydb new project structure](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/dbt-ydb-new-project.png)
