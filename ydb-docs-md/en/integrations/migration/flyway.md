---
title: "Migrating YDB data schemas with the Flyway migration tool"
url: "https://ydb.tech/docs/en/integrations/migration/flyway?version=v26.1"
doc_path: "en/integrations/migration/flyway"
version: "v26.1"
lang: "en"
source_path: "en/core/integrations/migration/flyway.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/integrations/migration/flyway.md"
...
[Flyway](https://documentation.red-gate.com/fd/) is an open-source database migration tool. It strongly favors simplicity and convention over configuration. It has extensions for various database management systems (DBMS), including YDB.

## Install

To use Flyway with YDB in a Java / Kotlin application or a Gradle / Maven plugin, you need to add dependencies for the Flyway core, the Flyway extension for YDB, and the [YDB JDBC Driver](https://github.com/ydb-platform/ydb-jdbc-driver):
...
To work with YDB via Flyway CLI, you need to install the `flyway` utility itself using [one of the recommended methods](https://documentation.red-gate.com/fd/command-line-184127404.html).
...
![_assets/flyway-baseline-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/flyway-baseline-step-1.png)
...
>
> You can see how to connect to YDB in the [next section](liquibase.md#connect-to-ydb).

As a result, a table named `flyway_schema_history` will be created, and it will contain a `baseline` record:

![_assets/flyway-baseline-step-2.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/flyway-baseline-step-2.png)
...
<details>
<summary>The contents of `V4__load_data.sql`</summary>
...
![_assets/flyway-migrate-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/flyway-migrate-step-1.png)
...
<details>
<summary>The contents of `V5__create_series_title_index.sql`</summary>
...
![_assets/flyway-migrate-step-2.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/flyway-migrate-step-2.png)
...
<details>
<summary>The contents of `V6__rename_series_title_index.sql`</summary>
...
![_assets/flyway-repair-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/flyway-repair-step-1.png)
...
![_assets/flyway-clean-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/integrations/migration/_assets/flyway-clean-step-1.png)
