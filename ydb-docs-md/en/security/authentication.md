...
url: "https://ydb.tech/docs/en/security/authentication?version=v26.1"
doc_path: "en/security/authentication"
version: "v26.1"
lang: "en"
...
- [Anonymous](authentication.md#anonymous) authentication.
- Authentication by [username and password](authentication.md#static-credentials).
- [LDAP](authentication.md#ldap-auth-provider) authentication.
- [Authentication through a third-party IAM provider](authentication.md#iam), for example, [Yandex Identity and Access Management](https://yandex.cloud/en/docs/iam/).
...
Only digits and lowercase Latin letters can be used in usernames. [Password complexity requirements](authentication.md#password-complexity) can be configured.
...
To learn how to manage roles and users, see [Authorization](authorization.md).
...
- Automatically via the [`ldaps`](authentication.md#ldaps) connection scheme.
- Using the [`StartTls`](authentication.md#starttls) LDAP protocol extension\*.
