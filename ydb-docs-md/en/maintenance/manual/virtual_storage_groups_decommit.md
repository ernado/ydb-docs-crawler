---
title: "Decommissioning groups using virtual groups"
url: "https://ydb.tech/docs/en/maintenance/manual/virtual_storage_groups_decommit?version=v26.1"
doc_path: "en/maintenance/manual/virtual_storage_groups_decommit"
version: "v26.1"
lang: "en"
source_path: "en/core/maintenance/manual/virtual_storage_groups_decommit.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/maintenance/manual/virtual_storage_groups_decommit.md"
description: "Alert."
...
![before-decommit](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/storage_groups_before.png)
...
![after-decommit](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/storage_group_after_decomm.png)
...
1. A deployed YDB [cluster](../../concepts/glossary.md#cluster). Deployment instructions are available in the [Initial Deployment](../../devops/deployment-options/manual/initial-deployment/index.md) section.
2. The `ydb-dstool` utility is installed. Installation instructions are available in the [YDB DSTool installation documentation](../../reference/ydb-dstool/install.md).
3. An authentication token generated for cluster access:

```bash
ydb -e grpc://<cluster-endpoint> -d <db_path> --user <user> auth get-token -f > ~/ydb_token
```
