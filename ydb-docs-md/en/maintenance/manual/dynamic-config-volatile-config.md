---
title: "Volatile Configurations"
url: "https://ydb.tech/docs/en/maintenance/manual/dynamic-config-volatile-config?version=v26.1"
doc_path: "en/maintenance/manual/dynamic-config-volatile-config"
version: "v26.1"
lang: "en"
...
These configurations are added to the end of the selector set, the description syntax is identical to [selector syntax](../../devops/configuration-management/configuration-v1/dynamic-config-selectors.md).
