---
title: "Blob Depot"
url: "https://ydb.tech/docs/en/maintenance/manual/blobdepot?version=v26.1"
doc_path: "en/maintenance/manual/blobdepot"
version: "v26.1"
lang: "en"
source_path: "en/core/maintenance/manual/blobdepot.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/maintenance/manual/blobdepot.md"
description: "Blob depot extends the functionality of the storage subsystem by adding virtual group functionality."
...
- [BS_CONTROLLER monitoring page](blobdepot.md#diag-bscontroller)
- [blob depot monitoring page](blobdepot.md#diag-blobdepot)
- [internal viewer](blobdepot.md#diag-viewer)
- [event log](blobdepot.md#diag-log)
- [charts](blobdepot.md#diag-sensors)
...
![Virtual groups](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/virtual-groups.png "Virtual groups")
...
| State | [Blob depot state](blobdepot.md#vg-check-running); can be NEW, WORKING, CREATED_FAILED. |
...
![BlobDepot stats](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-stats.png "BlobDepot stats")

This table provides the following data:

- Data, bytes — amount of saved data bytes ([TotalStoredDataSize](blobdepot.md#diag-sensors)).
- Trash in flight, bytes — amount of bytes of unnecessary data waiting for transactions to complete to become garbage ([InFlightTrashSize](blobdepot.md#diag-sensors)).
- Trash pending, bytes — amount of garbage bytes that have not yet been passed to garbage collection ([TotalStoredTrashSize](blobdepot.md#diag-sensors)).
- Data in GroupId# XXX, bytes — amount of data bytes in group XXX (both useful data and not yet collected garbage).

![BlobDepot main](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-main.png "BlobDepot main")
...
![data tab](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-data.png "data tab")
...
![refcount tab](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-refcount.png "refcount tab")
...
![trash tab](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-trash.png "trash tab")
...
![barriers tab](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-barriers.png "barriers tab")
...
![blocks tab](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-blocks.png "blocks tab")
...
![storage tab](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/blobdepot-storage.png "storage tab")
...
![Nodes](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/viewer-nodes.png "Nodes")
...
![Storage](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/maintenance/manual/_assets/viewer-storage.png "Storage")
