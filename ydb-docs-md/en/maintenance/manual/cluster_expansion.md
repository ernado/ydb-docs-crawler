...
url: "https://ydb.tech/docs/en/maintenance/manual/cluster_expansion?version=v26.1"
doc_path: "en/maintenance/manual/cluster_expansion"
version: "v26.1"
lang: "en"
...
If you deploy new static or dynamic nodes of the cluster on new servers added to the expanded YDB cluster, on each new server, you need to install the YDB software according to the procedures described in the [cluster deployment instructions](../../devops/deployment-options/manual/initial-deployment/index.md). Among other things, you need to:
...
1. Format the disks that will be used to store the YDB data by following the [procedure for the cluster deployment step](../../devops/deployment-options/manual/initial-deployment/deployment-preparation.md#prepare-disks)
...
To remove a static node from the YDB cluster, use the [documented decommissioning procedure](../../devops/deployment-options/manual/decommissioning.md).
