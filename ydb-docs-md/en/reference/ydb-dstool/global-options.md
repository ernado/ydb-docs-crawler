...
url: "https://ydb.tech/docs/en/reference/ydb-dstool/global-options?version=v26.1"
doc_path: "en/reference/ydb-dstool/global-options"
version: "v26.1"
lang: "en"
...
| `-e`, `--endpoint` | Endpoint to connect to the YDB cluster, in the format: `[PROTOCOL://]HOST[:PORT]`.  <br>Default values: PROTOCOL — `http`, PORT — `8765`. |
