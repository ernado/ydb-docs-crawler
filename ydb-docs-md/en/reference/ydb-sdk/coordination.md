---
title: "Working with coordination nodes"
url: "https://ydb.tech/docs/en/reference/ydb-sdk/coordination?version=v26.1"
doc_path: "en/reference/ydb-sdk/coordination"
version: "v26.1"
lang: "en"
source_path: "en/core/reference/ydb-sdk/coordination.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/reference/ydb-sdk/coordination.md"
description: "This article describes how to use the YDB SDK to coordinate the work of multiple client application instances using coordination nodes and their semaphores."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Working with coordination nodes

This article describes how to use the YDB SDK to coordinate the work of multiple client application instances using [coordination nodes](../../concepts/datamodel/coordination-node.md) and their semaphores.

## Creating a coordination node

Coordination nodes are created in YDB databases in the same namespace as other schema objects, such as [tables](../../concepts/datamodel/table.md) and [topics](../../concepts/datamodel/topic.md).
