---
title: "Configuring the YDB Docker container"
url: "https://ydb.tech/docs/en/reference/docker/configuration?version=v26.1"
doc_path: "en/reference/docker/configuration"
version: "v26.1"
lang: "en"
...
YDB is configured via environment variables when running in Docker. When [starting](start.md) the YDB Docker container with the `docker run` command, you can specify additional environment variables using the `-e` option to change the container's behavior. For more than one environment variable, specify this option multiple times. Below is the full list of supported environment variables.
...
| [`MON_PORT`](https://GitHub.com/ydb-platform/ydb/blob/8dde59cd0af86737d07a1cd8ff19811a2bd2b663/ydb/tests/library/harness/kikimr_port_allocator.py#L170) | `int` | `8765` | HTTP port of [Embedded UI](../embedded-ui/index.md) |
...
| [`YDB_KAFKA_PROXY_PORT`](https://github.com/ydb-platform/ydb/blob/be585b61d649a49fd32e91d9ceeee7e893068a60/ydb/public/tools/lib/cmds/__init__.py#L362) | `int` |  | Port for connecting using the [Kafka API](../kafka-api/index.md). An empty value disables Kafka API compatibility. |
