---
title: "Health check"
url: "https://ydb.tech/docs/en/reference/ydb-cli/commands/monitoring-healthcheck?version=v26.1"
doc_path: "en/reference/ydb-cli/commands/monitoring-healthcheck"
version: "v26.1"
lang: "en"
source_path: "en/core/reference/ydb-cli/commands/monitoring-healthcheck.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/reference/ydb-cli/commands/monitoring-healthcheck.md"
description: "YDB has a built-in self-diagnostic system that provides a brief report on the cluster status and information about existing issues. This report can be obtained"
...
- `options` — [subcommand options](monitoring-healthcheck.md#options).
...
| `--format` | Output format. Available options:<br>- `pretty` — overall database status. Possible values are provided in the [table](../../ydb-sdk/health-check-api.md#selfcheck-result).<br>- `json` — a detailed JSON response containing a hierarchical list of detected problems. Possible issues are listed in the [Healthcheck API](../../ydb-sdk/health-check-api.md#issues) documentation.<br>Default: `pretty`. |
