---
title: "Connecting to S3-compatible object storages"
url: "https://ydb.tech/docs/en/reference/ydb-cli/export-import/auth-s3?version=v26.1"
doc_path: "en/reference/ydb-cli/export-import/auth-s3"
version: "v26.1"
lang: "en"
...
The commands used to export data from S3-compatible storages, `export s3` and `import s3`, use the same parameters for S3 connection and authentication. To learn how to get these parameters for certain cloud providers, see [Getting S3 connection parameters](auth-s3.md#procure) below.
