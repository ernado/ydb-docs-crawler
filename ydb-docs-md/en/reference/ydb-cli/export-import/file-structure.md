---
title: "File structure of an export"
url: "https://ydb.tech/docs/en/reference/ydb-cli/export-import/file-structure?version=v26.1"
doc_path: "en/reference/ydb-cli/export-import/file-structure"
version: "v26.1"
lang: "en"
source_path: "en/core/reference/ydb-cli/export-import/file-structure.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/reference/ydb-cli/export-import/file-structure.md"
description: "The file structure outlined below is used to export data both to the file system and an S3-compatible object storage. When working with S3, the file path is add"
...
- Directories describing [databases](file-structure.md#db) in the cluster, except:
...
- Directories describing the database schema objects, for example, [tables](file-structure.md#tables)
...
- Directories describing the [changefeeds](../../../concepts/cdc.md). Directory names match the names of the changefeeds. Each directory contains the following files:
...
When you export the tables created under [YDB Quick Start](../../../quickstart.md) in Getting started, the system will create the following file structure:
