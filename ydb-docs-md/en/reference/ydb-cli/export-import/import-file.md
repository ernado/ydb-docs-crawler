---
title: "Importing data from a file to an existing table"
url: "https://ydb.tech/docs/en/reference/ydb-cli/export-import/import-file?version=v26.1"
doc_path: "en/reference/ydb-cli/export-import/import-file"
version: "v26.1"
lang: "en"
...
description: "Importing data from a file to an existing table. With the import file command, you can import data from CSV or TSV files to an existing table."
...
> [!NOTE]
> If the table doesn't exist yet, you can use the [ydb tools infer csv](../tools-infer.md) command to generate the `CREATE TABLE` statement based on an existing CSV file.
>
> You can also try to import into a non-existent table. In that case, the command will suggest running [ydb tools infer csv](../tools-infer.md) with the correct options.
...
Before performing the examples, [create a table](../../../quickstart.md) named `series`.
