...
url: "https://ydb.tech/docs/en/reference/ydb-cli/workload-tpcc?version=v26.1"
doc_path: "en/reference/ydb-cli/workload-tpcc"
version: "v26.1"
lang: "en"
source_path: "en/core/reference/ydb-cli/workload-tpcc.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/reference/ydb-cli/workload-tpcc.md"
description: "The workload is based on the TPC-C specification, with the queries and table schemas adapted for YDB."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# TPC-C Workload

The workload is based on the TPC-C [specification](https://www.tpc.org/tpc_documents_current_versions/pdf/tpc-c_v5.11.0.pdf), with the queries and table schemas adapted for YDB.
...
![Import](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/reference/ydb-cli/_assets/tpcc-import.gif)
...
During the benchmark, the CLI displays a preview of the results and various client side load statistics:  
 ![Run](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/reference/ydb-cli/_assets/tpcc-run.gif)
...
efficiency=tpmC12.86×warehouses×100\\text{efficiency} = \\frac{\\text{tpmC}}{12.86 \\times \\text{warehouses}} \\times 100 efficiency=12.86×warehousestpmC​×100
