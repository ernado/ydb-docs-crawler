---
title: "feature_flags"
url: "https://ydb.tech/docs/en/reference/configuration/feature_flags?version=v26.1"
doc_path: "en/reference/configuration/feature_flags"
version: "v26.1"
lang: "en"
...
| `enable_topic_compactification_by_key` | Enabling topic compactification in the [YDB Topics Kafka API](../kafka-api/index.md) |
| `enable_kafka_transactions` | Enabling transactions in the [YDB Topics Kafka API](../kafka-api/index.md) |
