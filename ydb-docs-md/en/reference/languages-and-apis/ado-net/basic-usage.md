---
title: "Basic Usage with ADO.NET"
url: "https://ydb.tech/docs/en/reference/languages-and-apis/ado-net/basic-usage?version=v26.1"
doc_path: "en/reference/languages-and-apis/ado-net/basic-usage"
version: "v26.1"
lang: "en"
source_path: "en/core/reference/languages-and-apis/ado-net/basic-usage.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/reference/languages-and-apis/ado-net/basic-usage.md"
description: "This article covers core ADO.NET usage scenarios for YDB, including database connections, query execution, and result processing. See the main documentation for"
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Basic Usage with ADO.NET

This article covers core [ADO.NET](https://learn.microsoft.com/en-us/dotnet/framework/data/adonet/) usage scenarios for YDB, including database connections, query execution, and result processing. See the main [documentation](index.md) for additional details.
...
1. **YdbDataSource.OpenConnectionAsync**:
   ...
   Opens a connection to YDB using the parameters set on YdbDataSource (see the [YDB Data Source section](basic-usage.md#data_source)).
...
2. **YdbDataSource.OpenRetryableConnectionAsync**:
   ...
   Opens a connection with automatic operation retries that follow the YDB Retry Policy (see the [retries section](basic-usage.md#retry_policy)).
   ...
   - Attempting to use a transaction will throw an exception (see the [transactions section](basic-usage.md#transactions)).
...
## Alternative Parameter Style with `@` Prefix {#prefix}
...
Retries are performed according to YDB policies (see the [retries section](basic-usage.md#retry_policy)).
...
> [!WARNING]
> See more about [Transaction Lock Invalidation](../../../troubleshooting/performance/queries/transaction-lock-invalidation.md))
...
- `BeginTransaction(TxMode txMode)`
   ...
   The `Ydb.Sdk.Services.Query.TxMode` is a YDB specific isolation level, you can read more about it [here](../../../concepts/transactions.md).
...
> [!NOTE]
> This section is relevant if you do not use the provider’s built-in retries (see the [retries section](basic-usage.md#retry_policy)).
...
### Properties of `YdbException` {#properties-of}
