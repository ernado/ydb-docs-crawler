---
title: "ADO.NET Supported Types and Their Mappings"
url: "https://ydb.tech/docs/en/reference/languages-and-apis/ado-net/type-mapping?version=v26.1"
doc_path: "en/reference/languages-and-apis/ado-net/type-mapping"
version: "v26.1"
lang: "en"
...
| Float | float |  |
| Double | double |  |
| Decimal (precision, scale) | decimal ([cм. раздел Decimal](type-mapping.md#decimal)) |  |
