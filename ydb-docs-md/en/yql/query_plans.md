---
title: "Query plan structure"
url: "https://ydb.tech/docs/en/yql/query_plans?version=v26.1"
doc_path: "en/yql/query_plans"
version: "v26.1"
lang: "en"
...
Below, you can find information about node types, and an example of analyzing a specific query plan can be found [here](../dev/query-execution-optimization/query-plans-optimization.md).
...
![stage](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/yql/_assets/stage.png)
...
Iterates through a given set of rows. Typically uses a [precompute](query_plans.md#precompute) as an argument.

#### PartitionByKey

Partitioning by key. Typically uses a [precompute](query_plans.md#precompute).

### Connection

Data dependencies between stages.

#### UI representation {#ui-representation1}

![connection](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/yql/_assets/connection.png)
...
#### UI representation {#ui-representation2}

![resultset](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/yql/_assets/resultset.png)

### Precompute

Materialized intermediate result.

#### UI representation {#ui-representation3}

![precompute](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/yql/_assets/precompute.png)
