...
url: "https://ydb.tech/docs/en/yql/reference/types/serial?version=v26.1"
doc_path: "en/yql/reference/types/serial"
version: "v26.1"
lang: "en"
...
> [!NOTE]
> Using serial types as a primary key is not recommended: monotonically increasing values lead to uneven data distribution and hot partitions. For details, see [Selecting a primary key for maximum performance](../../../dev/primary-key/row-oriented.md).
