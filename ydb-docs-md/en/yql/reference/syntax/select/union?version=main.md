---
title: "Combining subquery results (UNION)"
url: "https://ydb.tech/docs/en/yql/reference/syntax/select/union?version=main&version=v26.1"
doc_path: "en/yql/reference/syntax/select/union?version=main"
version: "v26.1"
lang: "en"
source_path: "en/core/yql/reference/syntax/select/union.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/yql/reference/syntax/select/union.md"
description: "UNION. Union of the results of the underlying queries, with duplicates removed. Behavior is identical to using UNION ALL followed by SELECT DISTINCT *."
...
Union of the results of the underlying queries, with duplicates removed.  
 ...
 Refer to [UNION ALL](union.md#union-all) for more details.
