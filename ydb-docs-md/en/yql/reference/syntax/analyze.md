...
The cost-based optimizer relies on table statistics and individual column statistics. YDB collects and maintains these statistics in the background. You can manually force statistics collection using the [ANALYZE](analyze.md) query.
...
In YDB, you can configure the cost optimization level via the [CostBasedOptimizationLevel](pragma.md#costbasedoptimizationlevel) pragma.
