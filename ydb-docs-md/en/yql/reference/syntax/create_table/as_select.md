---
title: "Creating a table filled with query results"
url: "https://ydb.tech/docs/en/yql/reference/syntax/create_table/as_select?version=v26.1"
doc_path: "en/yql/reference/syntax/create_table/as_select"
version: "v26.1"
lang: "en"
source_path: "en/core/yql/reference/syntax/create_table/as_select.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/yql/reference/syntax/create_table/as_select.md"
description: "Warning. Supported only for column-oriented tables. Support for row-oriented tables is currently under development."
...
`CREATE TABLE AS` creates a new table [table](../../../../concepts/datamodel/table.md) filled with data from query results.
