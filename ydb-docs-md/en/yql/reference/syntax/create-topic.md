---
title: "CREATE TOPIC"
url: "https://ydb.tech/docs/en/yql/reference/syntax/create-topic?version=v26.1"
doc_path: "en/yql/reference/syntax/create-topic"
version: "v26.1"
lang: "en"
...
You can use the `CREATE TOPIC` statement to create a [topic](../../../concepts/datamodel/topic.md), as well as [consumers](../../../concepts/datamodel/topic.md#consumer) for it.
...
- `min_active_partitions` — minimum number of active topic partitions. [Autopartitioning](../../../concepts/datamodel/topic.md#autopartitioning) will not decrease the number of active partitions below this value. Value type — `integer`, default value — `1`.

- `max_active_partitions` — maximum number of active topic partitions. [Autopartitioning](../../../concepts/datamodel/topic.md#autopartitioning) will not increase the number of active partitions above this value. Value type — `integer`, by default equal to `min_active_partitions`.
...
- `auto_partitioning_strategy` — [autopartitioning mode](../../../concepts/datamodel/topic.md#autopartitioning_strategies).
