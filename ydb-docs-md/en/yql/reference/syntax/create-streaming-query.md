...
url: "https://ydb.tech/docs/en/yql/reference/syntax/create-streaming-query?version=v26.1"
doc_path: "en/yql/reference/syntax/create-streaming-query"
version: "v26.1"
lang: "en"
...
Creation examples are [below](create-streaming-query.md#examples).
...
More examples: [Common streaming query patterns](../../../dev/streaming-query/patterns.md).
