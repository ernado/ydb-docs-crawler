---
title: "ALTER TOPIC"
url: "https://ydb.tech/docs/en/yql/reference/syntax/alter-topic?version=v26.1"
...
You can use the `ALTER TOPIC` command to change the [topic](../../../concepts/datamodel/topic.md) settings, as well as add, update, or delete its consumers.
...
`ADD CONSUMER`: Adds a [consumer](../../../concepts/datamodel/topic.md#consumer) to a topic.
