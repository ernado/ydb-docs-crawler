...
url: "https://ydb.tech/docs/en/yql/reference/recipes/ttl?version=v26.1"
doc_path: "en/yql/reference/recipes/ttl"
version: "v26.1"
lang: "en"
...
> [!TIP]
> An `Interval` is created from a string literal in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format with [some restrictions](../builtins/basic.md#data-type-literals).
