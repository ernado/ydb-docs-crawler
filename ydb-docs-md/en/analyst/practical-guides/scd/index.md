---
title: "Working with slowly changing dimensions"
url: "https://ydb.tech/docs/en/analyst/practical-guides/scd/?version=v26.1"
doc_path: "en/analyst/practical-guides/scd/"
version: "v26.1"
lang: "en"
source_path: "en/core/analyst/practical-guides/scd/index.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/analyst/practical-guides/scd/index.md"
description: "This section contains practical guides for implementing slowly changing dimensions (Slowly Changing Dimensions, SCD) — a popular approach to managing historical"
...
- [SCD Type 1](index.md#scd1): Old attribute values are replaced with new ones, keeping only the current state of data.
- [SCD Type 2](index.md#scd2): The full history of changes is preserved by adding new records for each new attribute version.
...
- Using the combination of [Change Data Capture (CDC)](../../../concepts/cdc.md) and [Transfer](../../../concepts/transfer.md) for automatic streaming replication of changes from source tables.
  ...
  - [Using the TRANSFER mechanism to implement SCD1 based on data from CDC sources in YDB](scd1-transfer.md)
  - [Using the TRANSFER mechanism to implement SCD2 based on data from CDC sources in YDB](scd2-transfer.md)
...
- Using periodic YQL queries that process batches of changes from the intermediate table and merge them into the main SCD table.
  ...
  - [Using the merge process to implement SCD2 in YDB](scd2-merge.md)
