---
title: "Using the TRANSFER mechanism to implement SCD2 based on data from CDC sources in YDB"
url: "https://ydb.tech/docs/en/analyst/practical-guides/scd/scd2-transfer?version=v26.1"
doc_path: "en/analyst/practical-guides/scd/scd2-transfer"
version: "v26.1"
lang: "en"
...
This article describes the implementation of the Slowly Changing Dimensions Type 2 (SCD2) pattern in YDB.

## Used tools

For delivering data to the SCD2 table, the following combination of functional capabilities of YDB will be used in this article:
