...
url: "https://ydb.tech/docs/en/contributor/spilling-service?version=v26.1"
doc_path: "en/contributor/spilling-service"
version: "v26.1"
lang: "en"
source_path: "en/core/contributor/spilling-service.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/contributor/spilling-service.md"
...
The **Spilling Service** is an [actor service](../concepts/glossary.md#actor-service) that provides temporary storage for data blobs in the YDB system. The service operates as a key-value store where clients can save data using a unique identifier and later retrieve it with that identifier.
