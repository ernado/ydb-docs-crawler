---
title: "Internals of the V2 configuration mechanism"
url: "https://ydb.tech/docs/en/contributor/configuration-v2?version=v26.1"
doc_path: "en/contributor/configuration-v2"
version: "v26.1"
lang: "en"
...
The V2 configuration in YDB provides a unified approach to managing cluster settings. While the [DevOps section](../devops/configuration-management/configuration-v2/config-overview.md) describes how to use this mechanism, this article focuses on its technical design. It will be useful for YDB developers and contributors who want to make changes to this mechanism, as well as anyone who wants to gain a deeper understanding of what happens in a YDB cluster when the configuration changes.
...
### Scatter/Gather — Command Propagation Mechanism {#scatter/gather-—-command-propagation-mechanism}
