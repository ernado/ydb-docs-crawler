---
title: "Quickstart: reading and writing topics"
url: "https://ydb.tech/docs/en/recipes/streaming_queries/topics?version=v26.1"
doc_path: "en/recipes/streaming_queries/topics"
version: "v26.1"
lang: "en"
...
- [Create topics](topics.md#step1);
- [Create an external data source](topics.md#step2);
- [Create the streaming query](topics.md#step3);
- [Check query state](topics.md#step4);
- [Produce sample input](topics.md#step5);
- [Read the output topic](topics.md#step6);
- [Delete the streaming query](topics.md#step7).

## Prerequisites {#requirements}

You need:

- A running YDB database — see [quick start](../../quickstart.md);
...
- `GROUP BY HOP` and `HOP_START` — [GROUP BY ... HOP](../../yql/reference/syntax/select/group-by.md#group-by-hop).
- Writing to topics — [Write formats](../../dev/streaming-query/streaming-query-formats.md#write_formats).
- JSON serialization: [TableRow](../../yql/reference/builtins/basic.md#tablerow), [Yson::From](../../yql/reference/udf/list/yson.md#ysonfrom), [Yson::SerializeJson](../../yql/reference/udf/list/yson.md#ysonserializejson), [Unwrap](../../yql/reference/builtins/basic.md#unwrap), [ToBytes](../../yql/reference/builtins/basic.md#to-from-bytes).
...
Write test messages with [YDB CLI](../../reference/ydb-cli/index.md):
