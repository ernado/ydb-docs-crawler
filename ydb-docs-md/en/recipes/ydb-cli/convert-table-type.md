---
title: "Convert a table between row-oriented and column-oriented"
url: "https://ydb.tech/docs/en/recipes/ydb-cli/convert-table-type?version=v26.1"
doc_path: "en/recipes/ydb-cli/convert-table-type"
version: "v26.1"
lang: "en"
source_path: "en/core/recipes/ydb-cli/convert-table-type.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/recipes/ydb-cli/convert-table-type.md"
description: "YDB supports two main types of tables: row-oriented and column-oriented. The chosen table type determines the physical representation of data on disks, so chang"
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Convert a table between row-oriented and column-oriented

YDB supports two main types of tables: [row-oriented](../../concepts/datamodel/table.md#row-oriented-tables) and [column-oriented](../../concepts/datamodel/table.md#column-oriented-tables). The chosen table type determines the physical representation of data on disks, so changing the type in place is impossible. However, you can create a new table of a different type and copy the data. This recipe consists of the following steps:

1. [Prepare a new table](convert-table-type.md#prepare)
2. [Copy data](convert-table-type.md#copy)
3. [Switch the workload](convert-table-type.md#switch) *(optional)*
...
> [!NOTE]
> The examples use the `quickstart` profile. To learn more, see [Creating a profile to connect to a test database](../../reference/ydb-cli/profile/create.md#quickstart).
...
<details>
<summary>Example test data and table schemas</summary>
