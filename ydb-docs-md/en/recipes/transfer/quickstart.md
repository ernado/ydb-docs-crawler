---
title: "Transfer — quick start"
url: "https://ydb.tech/docs/en/recipes/transfer/quickstart?version=v26.1"
doc_path: "en/recipes/transfer/quickstart"
version: "v26.1"
lang: "en"
...
This guide helps you get started with [transfer](../../concepts/transfer.md) in YDB using a basic example.

This guide covers the following steps for working with transfers:

- [creating a topic](quickstart.md#step1), for the transfer to read from;
- [creating a table](quickstart.md#step2), for the transfer to write data to;
- [creating the transfer](quickstart.md#step3);
- [populating the topic with data](quickstart.md#step4);
- [verifying the table contents](quickstart.md#step5).

## Step 1. Create a topic {#step1}

First, you need to create a [topic](../../concepts/datamodel/topic.md) in YDB that the transfer will read data from. You can do this using a [YQL query](../../yql/reference/syntax/create-topic.md):
...
After creating the transfer, you can write messages to the topic, for example, using the [YDB CLI](../../reference/ydb-cli/index.md).
...
- [Transfer — streaming NGINX access logs to a table](nginx.md)
