...
url: "https://ydb.tech/docs/en/recipes/ydb-sdk/distributed-lock?version=v26.1"
doc_path: "en/recipes/ydb-sdk/distributed-lock"
version: "v26.1"
lang: "en"
...
Consider a scenario where it is necessary to ensure that only one instance of a client application accesses a shared resource at any given time. To achieve this, the semaphore mechanism in [YDB coordination nodes](../../reference/ydb-sdk/coordination.md) can be utilized.
