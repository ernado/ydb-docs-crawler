---
title: "Retrying"
url: "https://ydb.tech/docs/en/recipes/ydb-sdk/retry?version=v26.1"
doc_path: "en/recipes/ydb-sdk/retry"
version: "v26.1"
lang: "en"
source_path: "en/core/recipes/ydb-sdk/retry.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/recipes/ydb-sdk/retry.md"
description: "YDB is a distributed database management system with automatic load scaling."
...
- C++
  ...
  <details>
  <summary>Synchronous retry attempts</summary>
  ...
  <details>
  <summary>Asynchronous retry attempts</summary>
  ...
  <details>
  <summary>Retry attempts for streaming queries</summary>
  ...
  <details>
  <summary>Configuring retry parameters</summary>
...
- Go
  ...
  - Native SDK
    ...
    <details>
    <summary>General-purpose repeat function</summary>
    ...
    <details>
    <summary>Repeat attempts in case of failed YDB session objects</summary>
    ...
    <details>
    <summary>Repeat attempts in case of failed YDB interactive transaction objects</summary>
    ...
    <details>
    <summary>Queries to other YDB services</summary>
  ...
  - database/sql
    ...
    <details>
    <summary>Repeat attempts in case of failed `*sql.Conn` connection objects:</summary>
    ...
    <details>
    <summary>Repeat attempts in case of failed `*sql.Tx` interactive transaction objects:</summary>
...
- Java
  ...
  - Native SDK
    ...
    <details>
    <summary>Sample code using SessionRetryContext.supplyStatus:</summary>
    ...
    <details>
    <summary>Sample code using SessionRetryContext.supplyResult:</summary>
