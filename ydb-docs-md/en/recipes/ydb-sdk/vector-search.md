---
title: "Vector search"
url: "https://ydb.tech/docs/en/recipes/ydb-sdk/vector-search?version=v26.1"
doc_path: "en/recipes/ydb-sdk/vector-search"
version: "v26.1"
lang: "en"
source_path: "en/core/recipes/ydb-sdk/vector-search.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/recipes/ydb-sdk/vector-search.md"
description: "This section contains code recipes in different programming languages for vector search tasks using the YDB SDK. The following operations are covered in detail:"
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Vector search

This section contains code recipes in different programming languages for [vector search](../../concepts/query_execution/vector_search.md) tasks using the YDB SDK.

The following operations are covered in detail:

- [Vector search](vector-search.md#vector-search)

  - [Connecting to YDB](vector-search.md#connect-ydb)
  - [Creating a table](vector-search.md#create-table)
  - [Inserting vectors](vector-search.md#insert-vectors)
  - [Adding an index](vector-search.md#add-vector-index)
  - [Search by vector](vector-search.md#search-by-vector)
  - [Full example](vector-search.md#full-example)
...
This section describes the minimum steps required to run queries in YDB.  
 For more information on connecting to YDB, see [Initialize the driver](init.md).
...
In YDB tables, vectors are stored as serialized byte sequences. **Prefer performing this conversion on the client.** Alternatively, delegate conversion to the server using [Knn UDF](../../yql/reference/udf/list/knn.md#functions-convert). Examples for both approaches follow.
