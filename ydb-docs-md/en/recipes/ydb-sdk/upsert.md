---
title: "Upsert data"
url: "https://ydb.tech/docs/en/recipes/ydb-sdk/upsert?version=v26.1"
doc_path: "en/recipes/ydb-sdk/upsert"
version: "v26.1"
lang: "en"
...
Below are code examples of using the built-in upsert tools of the YDB SDK:
...
- Python
  ...
  - SQLAlchemy
    ...
    When using YDB via SQLAlchemy, the `ydb_sqlalchemy.upsert` function is used to insert data, which generates an `UPSERT INTO` query based on the table and the passed values. You can insert either a single row or multiple rows in one call:
