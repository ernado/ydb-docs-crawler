...
description: "This page contains a detailed description of the code of a test app that is available as part of the YDB C++SDK. Initializing a database connection."
