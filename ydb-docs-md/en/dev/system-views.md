...
| `ResourceWeight` | [Weights](resource-consumption-management.md#resources_weight) for distributing resources among pools.  <br>Type: `Double`. |
...
The `auth_users` view contains a list of local [users](../concepts/glossary.md#access-user) YDB. It does not include users authenticated through external systems such as LDAP.
...
| `Permission` | Name of the [access right](../yql/reference/syntax/grant.md#permissions-list) YDB.  <br>Type: `Utf8`.  <br>Key: `2`. |
