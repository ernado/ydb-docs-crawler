...
url: "https://ydb.tech/docs/en/dev/query-execution-optimization/query-hints?version=v26.1"
doc_path: "en/dev/query-execution-optimization/query-hints"
version: "v26.1"
lang: "en"
...
### JoinType - Join algorithm {#jointype-join-algorithm}
...
### 3. Bytes - Data Size Hints {#3-bytes-data-size-hints}
...
#### Parameters are similar to Rows, but apply to the size of the data in bytes {#parameters-are-similar-to-rows,-but-apply-to-the-size-of-the-data-in-bytes}
...
### 4. JoinOrder - Join order {#4-joinorder-join-order}
