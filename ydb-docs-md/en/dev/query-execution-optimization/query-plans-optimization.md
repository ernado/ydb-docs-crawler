...
url: "https://ydb.tech/docs/en/dev/query-execution-optimization/query-plans-optimization?version=v26.1"
doc_path: "en/dev/query-execution-optimization/query-plans-optimization"
version: "v26.1"
lang: "en"
source_path: "en/core/dev/query-execution-optimization/query-plans-optimization.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/en/core/dev/query-execution-optimization/query-plans-optimization.md"
description: "It's very useful to to analyze execution plans for queries in order to detect and eliminate the causes of possible inefficiencies. YDB provides two types of que"
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Query plan optimization

It's very useful to to analyze execution plans for queries in order to detect and eliminate the causes of possible inefficiencies. YDB provides two types of query plans: logical plan and execution plan. Logical plan is better suited for analyzing complex queries with a large number of [JOIN](../../yql/reference/syntax/select/join.md) operators. Execution plan is more detailed: it additionally shows the stages of the distributed plan and connectors between them, which makes it more convenient for analyzing simple OLTP queries.

## Logical Query Plan

You can get the logical plan via YDB [CLI](../../reference/ydb-cli/commands/explain-plan.md).
...
![episodes](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/_assets/episodes_scheme.png)
...
- YDB CLI
  ...
  You can build a query plan via YDB [CLI](../../reference/ydb-cli/commands/explain-plan.md) using the following command:
...
- Embedded UI
  ...
  ![explain_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/_assets/explain_ui.png)

  Result:

  ![query_plan_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/_assets/query_plan_ui.png)
...
Please note that this example uses [synchronous secondary index](../../concepts/query_execution/secondary_indexes.md#sync). Building an index in YDB is an asynchronous operation. Even if the index creation query is successful, it is advisable to wait for some time because the index may not be ready for use immediately. You can manage asynchronous operations through the [CLI](../../reference/ydb-cli/commands/secondary_index.md#add).
...
- Embedded UI
  ...
  ![explain_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/_assets/explain_with_index_ui.png)

  Result:

  ![query_plan_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/en/core/_assets/query_plan_with_index_ui.png)
