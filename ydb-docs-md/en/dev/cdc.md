...
url: "https://ydb.tech/docs/en/dev/cdc?version=v26.1"
doc_path: "en/dev/cdc"
version: "v26.1"
lang: "en"
...
With [Change Data Capture](../concepts/cdc.md) (CDC), you can track changes in table data. YDB provides access to changefeeds so that data consumers can monitor changes in near real time.
...
As a load generator, you can use the feature of [emulating an online store](../reference/ydb-cli/commands/workload/stock.md) built into the YDB CLI:

1. [Initialize](../reference/ydb-cli/commands/workload/stock.md#init) a test.
2. Add a changefeed:
...
3. [Generate](../reference/ydb-cli/commands/workload/stock.md#run) a load.
