---
title: "SQLAlchemy"
url: "https://ydb.tech/docs/ru/integrations/orm/sqlalchemy?version=v26.1"
doc_path: "ru/integrations/orm/sqlalchemy"
version: "v26.1"
lang: "ru"
...
### Строка подключения {#stroka-podklyucheniya}
...
- `<cluster_url>` — адрес сервера YDB (например, `localhost`)
...
## Конфигурация подключения {#konfiguraciya-podklyucheniya}
...
YDB SQLAlchemy предоставляет полную поддержку типов данных YDB через пользовательские типы SQLAlchemy. Для получения подробной информации о системе типов YDB см. [документацию по типам данных YDB](../../concepts/datatypes.md).

### Сводная таблица типов {#svodnaya-tablica-tipov}
...
## Миграции с Alembic {#migracii-s-alembic}

### Конфигурация, специфичная для YDB {#konfiguraciya,-specifichnaya-dlya-ydb}
