---
title: "Расширение JOOQ для использования с YDB"
url: "https://ydb.tech/docs/ru/integrations/orm/jooq?version=v26.1"
doc_path: "ru/integrations/orm/jooq"
version: "v26.1"
lang: "ru"
source_path: "ru/core/integrations/orm/jooq.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/integrations/orm/jooq.md"
description: "Это руководство предназначено для использования JOOQ с YDB."
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Расширение JOOQ для использования с YDB

Это руководство предназначено для использования [JOOQ](https://www.jooq.org/) с YDB.
...
## Генерация Java-классов {#generaciya-java-klassov}

Генерировать Java-классы можно с помощью любых инструментов, представленных на [официальном сайте JOOQ](https://www.jooq.org/doc/latest/manual/code-generation/codegen-configuration/), используя две зависимости: YDB JDBC Driver и расширение JOOQ для YDB. Также необходимо указать два параметра:
...
Для интеграции YDB с JOOQ в ваш проект потребуется добавить две зависимости: YDB JDBC Driver и расширение JOOQ для YDB.
...
В остальном диалект YDB соответствует [документации JOOQ](https://www.jooq.org/doc/latest/manual/).

### Конфигурация Spring Boot {#konfiguraciya-spring-boot}
