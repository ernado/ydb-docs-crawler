---
title: "Диалект YDB для Hibernate"
url: "https://ydb.tech/docs/ru/integrations/orm/hibernate?version=v26.1"
doc_path: "ru/integrations/orm/hibernate"
version: "v26.1"
lang: "ru"
source_path: "ru/core/integrations/orm/hibernate.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/integrations/orm/hibernate.md"
description: "Введение. Это руководство использования Hibernate с YDB."
...
Это руководство использования [Hibernate](https://hibernate.org/orm/) с YDB.
...
Сконфигурируйте Hibernate для использования диалекта YDB, обновив [persistence.xml](https://docs.jboss.org/hibernate/orm/6.4/introduction/html_single/Hibernate_Introduction.html#configuration-jpa) файл:
...
Диалект YDB поддерживает `@OneToMany`, `@ManyToOne`, `@ManyToMany` связи.
