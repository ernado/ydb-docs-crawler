---
title: "LangChain"
url: "https://ydb.tech/docs/ru/integrations/vectorsearch/langchain?version=v26.1"
doc_path: "ru/integrations/vectorsearch/langchain"
version: "v26.1"
lang: "ru"
source_path: "ru/core/integrations/vectorsearch/langchain.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/integrations/vectorsearch/langchain.md"
description: "Интеграция YDB с LangChain позволяет использовать YDB в качестве векторного хранилища для RAG приложений."
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# LangChain

Интеграция YDB с [LangChain](https://python.langchain.com/docs/introduction/) позволяет использовать YDB в качестве [векторного хранилища](https://python.langchain.com/docs/concepts/vectorstores/) для [RAG](https://python.langchain.com/docs/concepts/rag/) приложений.
...
Для использования этой интеграции установите локальный YDB. Для получения дополнительной информации см. [Установите и запустите YDB](../../quickstart.md#install).
...
#### Поиск по сходству {#poisk-po-shodstvu}
...
#### Поиск по сходству с оценкой {#poisk-po-shodstvu-s-ocenkoj}
