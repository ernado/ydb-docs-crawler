---
title: "Версионирование схемы данных и миграции в YDB с использованием \"goose\""
url: "https://ydb.tech/docs/ru/integrations/migration/goose?version=v26.1"
doc_path: "ru/integrations/migration/goose"
version: "v26.1"
lang: "ru"
source_path: "ru/core/integrations/migration/goose.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/integrations/migration/goose.md"
...
## Строка подключения к YDB {#stroka-podklyucheniya-k-ydb}
...
## Директория с файлами миграций {#direktoriya-s-fajlami-migracij}
...
## Управление миграциями с помощью goose {#upravlenie-migraciyami-s-pomoshyu-goose}

### Создание файлов миграций и применение их к базе {#sozdanie-fajlov-migracij-i-primenenie-ih-k-baze}
...
- Используя YDB UI по адресу `http://localhost:8765`
  ...
  ![YDB UI after apply first migration](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/goose-ydb-ui-after-first-migration.png)
...
- Используя YDB UI по адресу `http://localhost:8765`
  ...
  ![YDB UI after apply second migration](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/goose-ydb-ui-after-second-migration.png)
...
## "Горячий" список команд "goose" {#goryachij-spisok-komand-goose}
