---
title: "Интеграция dbt с YDB"
url: "https://ydb.tech/docs/ru/integrations/migration/dbt?version=v26.1"
doc_path: "ru/integrations/migration/dbt"
version: "v26.1"
lang: "ru"
source_path: "ru/core/integrations/migration/dbt.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/integrations/migration/dbt.md"
...
### Модели и их материализация {#modeli-i-ih-materializaciya}
...
### Тестовые/справочные данные, создаваемые из файлов CSV (сиды) {#testovye/spravochnye-dannye,-sozdavaemye-iz-fajlov-csv-sidy}
...
### Тестирование данных {#testirovanie-dannyh}
...
- Python 3.10+;
- dbt Core (1.8+);
- Существующий кластер YDB, однонодовая инсталляция из [быстрого старта](../../quickstart.md) будет достаточной.
...
### Подключение dbt к YDB кластеру {#podklyuchenie-dbt-k-ydb-klasteru}
...
## Создание проекта "c нуля" через команду dbt init {#sozdanie-proekta-c-nulya-cherez-komandu-dbt-init}
...
5. Внутри директории вашего проекта, вы увидите следующую структуру
   ...
   ![dbt-ydb new project structure](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/dbt-ydb-new-project.png)
...
## Запуск тестового примера {#zapusk-testovogo-primera}
...
4. Подготовьте тестовые данные через seeds
   ...
   Эта команда загрузит CSV-файлы из директории `data/` в таблицы `raw_*` YDB.
