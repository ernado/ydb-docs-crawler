---
title: "Миграции схемы данных YDB с помощью Flyway"
url: "https://ydb.tech/docs/ru/integrations/migration/flyway?version=v26.1"
doc_path: "ru/integrations/migration/flyway"
version: "v26.1"
lang: "ru"
...
[Flyway](https://documentation.red-gate.com/fd/) - это инструмент для миграции баз данных с открытым исходным кодом. Она имеет расширения для различных систем управления базами данных (СУБД), включая YDB.

## Установка {#install}

Чтобы использовать Flyway вместе с YDB в Java / Kotlin приложении или в Gradle / Maven плагине, требуется зависимости Flyway core, расширения Flyway для YDB и [YDB JDBC Driver](https://github.com/ydb-platform/ydb-jdbc-driver):
...
Для работы с YDB через Flyway CLI требуется установить `flyway` утилиту [любым из рекомендованных способов](https://documentation.red-gate.com/fd/command-line-184127404.html).

Затем утилита должна быть расширена с помощью диалекта YDB и драйвера JDBC:
...
![_assets/flyway-baseline-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/flyway-baseline-step-1.png)
...
>
> Как подключится к YDB можно посмотреть в [следующем разделе](liquibase.md#connect-to-ydb).

В результате будет создана таблица с именем `flyway_schema_history`, которая будет содержать запись `baseline`:

![_assets/flyway-baseline-step-2.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/flyway-baseline-step-2.png)
...
<details>
<summary>Содержимое файла `V4__load_data.sql`</summary>
...
![_assets/flyway-migrate-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/flyway-migrate-step-1.png)
...
<details>
<summary>Содержимое файла `V5__create_series_title_index.sql`</summary>
...
![_assets/flyway-migrate-step-2.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/flyway-migrate-step-2.png)
...
<details>
<summary>Содержимое файла `V6__rename_series_title_index.sql`</summary>
...
![_assets/flyway-repair-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/flyway-repair-step-1.png)
...
> [!WARNING]
> В отличие от других систем управления базами данных, YDB не имеет такую сущность как `SCHEMA`. Таким образом, команда `clean` удалит все пользовательские таблицы в вашей базе данных.
...
![_assets/flyway-clean-step-1.png](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/integrations/migration/_assets/flyway-clean-step-1.png)
