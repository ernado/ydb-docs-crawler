---
title: "SQLGlot"
url: "https://ydb.tech/docs/ru/integrations/sql-translation/sqlglot?version=v26.1"
doc_path: "ru/integrations/sql-translation/sqlglot"
version: "v26.1"
lang: "ru"
source_path: "ru/core/integrations/sql-translation/sqlglot.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/integrations/sql-translation/sqlglot.md"
description: "SQLGlot — это написанный на чистом Python парсер, транспилер, оптимизатор и форматировщик SQL, поддерживающий более двадцати диалектов (PostgreSQL, MySQL, Click"
...
При миграции в YDB плагин автоматически приводит конструкции исходного диалекта к правилам YQL. Например, имена с указанием схемы (`schema.table`) преобразуются в [путь YDB](../../concepts/datamodel/dir.md) с обратными кавычками:
