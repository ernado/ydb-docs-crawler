---
title: "Алертинг"
url: "https://ydb.tech/docs/ru/devops/observability/alerting?version=v26.1"
doc_path: "ru/devops/observability/alerting"
version: "v26.1"
lang: "ru"
source_path: "ru/core/devops/observability/alerting.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/devops/observability/alerting.md"
description: "Алертинг — это механизм автоматических оповещений, предназначенный для информирования администраторов или специалистов DevOps о событиях, требующих их внимания"
...
## Алертинг в YDB с использованием Prometheus Alerting Rules {#alerting-v-ydb-s-ispolzovaniem-prometheus-alerting-rules}
...
## Перед началом работы {#pered-nachalom-raboty}
...
## Примеры правил алертинга, которые рекомендуются к настройке для каждого кластера {#primery-pravil-alertinga,-kotorye-rekomenduyutsya-k-nastrojke-dlya-kazhdogo-klastera}

### YDB ExecPool High Utilization

**Описание:** Правило контролирует загрузку [пулов](../../concepts/glossary.md#resource-pool) в YDB. Срабатывает при превышении 90% утилизации, что может привести к деградации производительности и увеличению времени отклика запросов.  
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/devops/_assets/prometheus_exec_pool.png)
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/devops/_assets/prometheus_ticket_errors.png)
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/devops/_assets/prometheus_storage_usage_health_check.png)

## Полный конфигурационный файл {#polnyj-konfiguracionnyj-fajl}
...
## Рекомендации по настройке {#rekomendacii-po-nastrojke}
