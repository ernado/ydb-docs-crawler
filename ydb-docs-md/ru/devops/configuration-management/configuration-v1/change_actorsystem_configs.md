---
title: "Изменение конфигурации актор-системы"
url: "https://ydb.tech/docs/ru/devops/configuration-management/configuration-v1/change_actorsystem_configs?version=v26.1"
doc_path: "ru/devops/configuration-management/configuration-v1/change_actorsystem_configs"
version: "v26.1"
lang: "ru"
source_path: "ru/core/devops/configuration-management/configuration-v1/change_actorsystem_configs.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/devops/configuration-management/configuration-v1/change_actorsystem_configs.md"
description: "Актор-система — основа YDB, каждый компонент системы представляется одним или несколькими акторами."
...
## Описание конфига актор-системы {#opisanie-konfiga-aktor-sistemy}
...
## На статических узлах {#na-staticheskih-uzlah}
...
## На динамических узлах {#na-dinamicheskih-uzlah}
