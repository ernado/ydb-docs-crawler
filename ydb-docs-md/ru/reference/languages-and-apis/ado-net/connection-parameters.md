---
title: "Параметры подключения ADO.NET"
url: "https://ydb.tech/docs/ru/reference/languages-and-apis/ado-net/connection-parameters?version=v26.1"
doc_path: "ru/reference/languages-and-apis/ado-net/connection-parameters"
version: "v26.1"
lang: "ru"
...
## Базовые параметры подключения {#bazovye-parametry-podklyucheniya}
...
## Безопасность и шифрование {#bezopasnost-i-shifrovanie}
...
## Параметры полезные для Serverless приложений {#parametry-poleznye-dlya-serverless-prilozhenij}
