---
title: "Поддерживаемые типы данных в интеграции с ADO.NET и их соответствие"
url: "https://ydb.tech/docs/ru/reference/languages-and-apis/ado-net/type-mapping?version=v26.1"
doc_path: "ru/reference/languages-and-apis/ado-net/type-mapping"
version: "v26.1"
lang: "ru"
...
## Таблица сопоставления типов на чтение {#tablica-sopostavleniya-tipov-na-chtenie}
...
| `Float` | `float` |  |
| `Double` | `double` |  |
| `Decimal (precision, scale)` | `decimal` ([см. раздел Decimal](type-mapping.md#decimal)) |  |
...
## Таблица сопоставления типов на запись {#tablica-sopostavleniya-tipov-na-zapis}

Существует три правила, определяющие тип параметра в YDB:
...
| **YDB тип** | **.NET тип** | **Non-default .NET типы** | **YdbDbType** | **DbType** |
| --- | --- | --- | --- | --- |
...
> [!NOTE]
> При использовании List указывайте тип как побитовое **OR** YdbDbType.List с типом элемента. Например, чтобы задать YdbDbType для List, используйте `YdbDbType.List | YdbDbType.Int32`.
