---
title: "device list"
url: "https://ydb.tech/docs/ru/reference/ydb-dstool/device-list?version=v26.1"
doc_path: "ru/reference/ydb-dstool/device-list"
version: "v26.1"
lang: "ru"
source_path: "ru/core/reference/ydb-dstool/device-list.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/reference/ydb-dstool/device-list.md"
description: "С помощью подкоманды device list вы можете вывести список устройств хранения, доступных на кластере YDB. Общий вид команды:"
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# device list

С помощью подкоманды `device list` вы можете вывести список устройств хранения, доступных на кластере YDB.
...
- `list options` — [параметры подкоманды](device-list.md#options).
