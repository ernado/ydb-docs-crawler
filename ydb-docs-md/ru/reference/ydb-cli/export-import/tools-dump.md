...
description: "Кластер. Команда admin сluster dump выгружает в клиентскую файловую систему метаданные кластера, в описанном в статье Файловая структура выгрузки формате:"
