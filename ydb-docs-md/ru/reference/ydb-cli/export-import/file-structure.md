---
title: "Файловая структура выгрузки"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/export-import/file-structure?version=v26.1"
doc_path: "ru/reference/ydb-cli/export-import/file-structure"
version: "v26.1"
lang: "ru"
source_path: "ru/core/reference/ydb-cli/export-import/file-structure.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/reference/ydb-cli/export-import/file-structure.md"
description: "Описанная ниже файловая структура применяется для выгрузки как в файловую систему, так и в S3-совместимое объектное хранилище. При работе с S3 в ключ объекта за"
...
- Директории, содержащие информацию о [базах данных](file-structure.md#db) в кластере, за исключением:
...
- Директории, содержащие информацию о схемных объектах базы данных, например, о [таблицах](file-structure.md#tables)
...
- Директории для описания [потоков изменений](../../../concepts/cdc.md). Имя директории соответствует названию потока изменений. В директории находятся:
...
YDB генерирует контрольную сумму для каждого файла выгрузки и сохраняет ее в соответствующем файле с суффиксом `.sha256`.
...
При выгрузке таблиц, созданных в разделе [Быстрый старт с YDB](../../../quickstart.md) Начала работы, будет создана следующая файловая структура:
