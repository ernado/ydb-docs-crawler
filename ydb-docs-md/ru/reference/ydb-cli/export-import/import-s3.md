---
title: "Загрузка из S3-совместимого хранилища"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/export-import/import-s3?version=v26.1"
doc_path: "ru/reference/ydb-cli/export-import/import-s3"
version: "v26.1"
lang: "ru"
...
description: "Команда import s3 запускает на стороне сервера процесс загрузки из S3-совместимого хранилища данных и информации об объектах схемы, в описанном в статье Файлова"
...
> [!NOTE]
> Импорт таблиц из S3-совместимого хранилища данных в других форматах возможен с использованием [внешних таблиц](../../../concepts/query_execution/federated_query/s3/external_table.md), подробнее см. в статье [Импорт данных](../../../concepts/query_execution/federated_query/import_and_export.md#import).
