---
title: "Импорт данных из файла в существующую таблицу"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/export-import/import-file?version=v26.1"
doc_path: "ru/reference/ydb-cli/export-import/import-file"
version: "v26.1"
lang: "ru"
source_path: "ru/core/reference/ydb-cli/export-import/import-file.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/reference/ydb-cli/export-import/import-file.md"
description: "С помощью подкоманды import file вы можете импортировать данные из файлов форматов CSV, JSON, Parquet, TSV в существующую таблицу."
...
> [!NOTE]
> Если таблица еще не создана, можно использовать команду [ydb tools infer csv](../tools-infer.md) для получения текста `CREATE TABLE` на основе имеющегося CSV-файла.
>
> При попытке выполнить импорт в несуществующую таблицу будет предложено выполнить [ydb tools infer csv](../tools-infer.md) с нужными опциями.
...
Перед выполнением примеров [создайте таблицу](../../../quickstart.md) `series`.
