...
description: "С помощью команды workload вы можете запустить различные виды нагрузки для вашей БД. Общий вид команды: ydb [global options...] workload [subcommands...]."
