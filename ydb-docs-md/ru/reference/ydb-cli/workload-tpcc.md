---
title: "TPC-C нагрузка"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/workload-tpcc?version=v26.1"
doc_path: "ru/reference/ydb-cli/workload-tpcc"
version: "v26.1"
lang: "ru"
source_path: "ru/core/reference/ydb-cli/workload-tpcc.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/reference/ydb-cli/workload-tpcc.md"
description: "Нагрузка базируется на официальной спецификации TPC-C. Все запросы и схемы таблиц адаптированы под YDB."
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# TPC-C нагрузка

Нагрузка базируется на официальной [спецификации](https://www.tpc.org/tpc_documents_current_versions/pdf/tpc-c_v5.11.0.pdf) TPC-C. Все запросы и схемы таблиц адаптированы под YDB.
...
Данные будут сгенерированы и загружены в таблицы непосредственно ydb:
...
![Import](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/tpcc-import.gif)
...
| --- | --- | --- |
| `--warehouses` или `-w` | Количество складов TPC-C. | 10 |
| `--threads` | Количество потоков для загрузки данных TPC-C в базу данных. | auto |
...
Во время теста TUI отображает предварительные результаты и статистику нагрузки на стороне клиента:  
 ![Run](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/tpcc-run.gif)
...
| `--max-sessions` или `-m` | Мягкое ограничение на количество сессий БД. | auto |
...
эффективность=tpmC12.86×склады×100\\text{эффективность} = \\frac{\\text{tpmC}}{12.86 \\times \\text{склады}} \\times 100 эффективность=12.86×складыtpmC​×100
