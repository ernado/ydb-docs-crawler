---
title: "Пользовательская нагрузка"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/workload-query?version=v26.1"
doc_path: "ru/reference/ydb-cli/workload-query"
version: "v26.1"
lang: "ru"
source_path: "ru/core/reference/ydb-cli/workload-query.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/reference/ydb-cli/workload-query.md"
description: "Позволяет провести нагрузочное тестирование по заданному пользовательскому сценарию."
...
## Общий синтаксис {#obshij-sintaksis}
...
### Канонические результаты {#kanonicheskie-rezultaty}
...
## Пример запуска пользовательского теста {#primer-zapuska-polzovatelskogo-testa}

### Скачайте пример из репозитория {#skachajte-primer-iz-repozitoriya}
...
### Запустите инициализацию {#zapustite-inicializaciyu}
...
### Запустите импорт данных {#zapustite-import-dannyh}
...
### Запустите нагрузочный тест {#zapustite-nagruzochnyj-test}
...
### Очистите таблицы {#ochistite-tablicy}
