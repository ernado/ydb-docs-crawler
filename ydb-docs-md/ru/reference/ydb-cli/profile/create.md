---
title: "Создание и изменение профиля"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/profile/create?version=v26.1"
doc_path: "ru/reference/ydb-cli/profile/create"
version: "v26.1"
lang: "ru"
source_path: "ru/core/reference/ydb-cli/profile/create.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/reference/ydb-cli/profile/create.md"
description: "Значения параметров соединения для создаваемого или изменяемого профиля могут быть заданы в командной строке, или запрошены в интерактивном режиме из консоли."
revision: "be5a7d10b3ef95ed6c3f719d85a8cf83cd01dff2"
---

# Создание и изменение профиля

Значения параметров соединения для создаваемого или изменяемого профиля могут быть заданы [в командной строке](create.md#cmdline), или запрошены [в интерактивном режиме](create.md#interactive) из консоли.
...
- `<connection options>` -- [параметры соединения](../connect.md#command-line-pars) для записи в профиле. Необходимо указание как минимум одного параметра соединения, иначе команда будет выполняться в [интерактивном режиме](create.md#interactive).
...
Вы можете использовать профиль `quickstart` для соединения с БД в составе одноузлового кластера YDB:
...
2. Введите [эндпоинт](../../../concepts/connect.md#endpoint) или не сохраняйте этот параметр для профиля:
...
3. Введите [имя базы данных](../../../concepts/connect.md#database) или не сохраняйте этот параметр для профиля:
...
4. Выберите режим аутентификации или не сохраняйте этот параметр для профиля:
   ...
   Все доступные методы аутентификации описаны в статье [Аутентификация](../../../security/authentication.md). Набор методов и текст подсказок может отличаться от приведенного в данном примере.
...
5. На последнем шаге вам будет предложено активировать созданный профиль для использования по умолчанию. Ответьте 'n' (Нет), пока вы не прочитали статью про [Активацию профиля и применение активированного профиля](activate.md):
