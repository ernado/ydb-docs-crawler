...
url: "https://ydb.tech/docs/ru/reference/ydb-cli/profile/delete?version=v26.1"
doc_path: "ru/reference/ydb-cli/profile/delete"
version: "v26.1"
lang: "ru"
...
description: "Удаление профиля производится следующей командой: ydb config profile delete <profile_name> [-f]. Параметры. <profile_name>: Имя профиля."
...
### Удаление профиля mydb1 без интерактивного подтверждения {#udalenie-profilya-mydb1-bez-interaktivnogo-podtverzhdeniya}
...
### Удаление профиля mydb1 с интерактивным подтверждением {#udalenie-profilya-mydb1-s-interaktivnym-podtverzhdeniem}
...
### Удаление всех профилей {#udalenie-vseh-profilej}
