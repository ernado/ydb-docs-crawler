---
title: "Интерактивный режим выполнения запросов"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/interactive-cli?version=v26.1"
doc_path: "ru/reference/ydb-cli/interactive-cli"
version: "v26.1"
lang: "ru"
source_path: "ru/core/reference/ydb-cli/interactive-cli.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/reference/ydb-cli/interactive-cli.md"
...
## Общее описание {#obshee-opisanie}

После выполнения команды `ydb` без подкоманд запускается интерактивный режим выполнения запросов. После этого можно вводить запросы напрямую в консоль или терминал. При вводе символа перевода строки запрос считается законченным, и он начинает исполняться. Текст запроса может представлять из себя как YQL запрос, так и [специальную команду](interactive-cli.md#spec-commands).
...
![Пример](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/general-example.gif)

Интерактивный режим выполнения запросов в YDB CLI предоставляет следующие возможности:

- [Подсветка синтаксиса](interactive-cli.md#syntax-highlighting)
- [Горячие клавиши](interactive-cli.md#hotkeys)
- [История запросов](interactive-cli.md#query-history)
- [Автодополнение](interactive-cli.md#auto-completion)
- [Специальные команды](interactive-cli.md#spec-commands)

## Подсветка синтаксиса {#syntax-highlighting}

![Подсветка синтаксиса](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/highlighting.jpg)
...
![История](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/history.gif)

История сохраняется локально и доступна между запусками CLI.

Также поддерживается функция поиска по запросам (`CTRL + R`):

![Поиск](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/history-search.gif)
...
![Автодополнение](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/candidates.gif)
...
![Интерактивные подсказки](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/reference/ydb-cli/_assets/hints.gif)
...
| Команда | Описание |
| --- | --- |
| `SET param = value` | Устанавливает значение [внутренней переменной](interactive-cli.md#internal-vars) `param` в `value`. |
...
Внутренние переменные устанавливают поведение команд и задаются с помощью [специальной команды](interactive-cli.md#spec-commands) `SET`.

| Переменная | Описание |
| --- | --- |
| `stats` | Режим сбора статистики для последующих запросов.  <br>Возможные значения:<br>- `none` (по умолчанию) — не собирать;<br>- `basic` — собирать статистику;<br>- `full` — собирать статистику и план запроса. |
