---
title: "Выполнение скрипта (с поддержкой стриминга)"
url: "https://ydb.tech/docs/ru/reference/ydb-cli/yql?version=v26.1"
doc_path: "ru/reference/ydb-cli/yql"
version: "v26.1"
lang: "ru"
...
- `options` — [параметры подкоманды](yql.md#options).
...
| `--stats` | Режим сбора статистики.  <br> Возможные значения:<br>- `none` (по умолчанию) — не собирать;<br>- `basic` — собирать по основным событиям;<br>- `full` — собирать по всем событиям. |
