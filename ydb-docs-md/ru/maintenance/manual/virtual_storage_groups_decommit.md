---
title: "Декомиссия групп с использованием виртуальных групп"
url: "https://ydb.tech/docs/ru/maintenance/manual/virtual_storage_groups_decommit?version=v26.1"
doc_path: "ru/maintenance/manual/virtual_storage_groups_decommit"
version: "v26.1"
lang: "ru"
source_path: "ru/core/maintenance/manual/virtual_storage_groups_decommit.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/maintenance/manual/virtual_storage_groups_decommit.md"
...
## Описание работы {#opisanie-raboty}
...
![before-decommit](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/maintenance/manual/_assets/storage_groups_before.png)
...
![after-decommit](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/maintenance/manual/_assets/storage_group_after_decomm.png)

## Этапы процесса декомиссии {#etapy-processa-dekomissii}
...
### Инициализация виртуальной группы хранения и блокировка записи в исходную физическую группу {#inicializaciya-virtualnoj-gruppy-hraneniya-i-blokirovka-zapisi-v-ishodnuyu-fizicheskuyu-gruppu}
...
### Копирование метаданных {#kopirovanie-metadannyh}
...
### Копирование данных {#kopirovanie-dannyh}
...
### Освобождение ресурсов исходной физической группы {#osvobozhdenie-resursov-ishodnoj-fizicheskoj-gruppy}
...
1. Развернутый [кластер](../../concepts/glossary.md#cluster) YDB. Инструкции по развертыванию доступны в разделе [Первоначальное развёртывание](../../devops/deployment-options/manual/initial-deployment/index.md).
2. Установленная утилита `ydb-dstool`. Инструкции по установке доступны в [документации по установке YDB DSTool](../../reference/ydb-dstool/install.md).
...
## Запуск декомиссии {#zapusk-dekomissii}

### Выбор группы для декомиссии {#vybor-gruppy-dlya-dekomissii}
...
### Команда для запуска {#komanda-dlya-zapuska}
...
### Параметры команды {#parametry-komandy}
...
## Проверка статуса декомиссии {#proverka-statusa-dekomissii}
...
### Пример вывода команды {#primer-vyvoda-komandy}
