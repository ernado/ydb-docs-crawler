---
title: "Освобождение места на физических устройствах"
url: "https://ydb.tech/docs/ru/maintenance/manual/disk_end_space?version=v26.1"
doc_path: "ru/maintenance/manual/disk_end_space"
version: "v26.1"
lang: "ru"
...
## Дефрагментировать VDisk {#defragmentirovat-vdisk}
...
## Перевоз отдельных VDisk'ов с заполненных устройств {#perevoz-otdelnyh-vdiskov-s-zapolnennyh-ustrojstv}
