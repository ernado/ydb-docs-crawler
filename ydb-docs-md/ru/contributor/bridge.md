---
title: "Устройство режима bridge"
url: "https://ydb.tech/docs/ru/contributor/bridge?version=v26.1"
doc_path: "ru/contributor/bridge"
version: "v26.1"
lang: "ru"
source_path: "ru/core/contributor/bridge.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/contributor/bridge.md"
...
Общее описание режима и сценарии использования см. в статье [Режим работы кластера Bridge](../concepts/bridge.md). Эта статья предназначена для разработчиков и контрибьюторов YDB и содержит технические детали реализации режима bridge.
...
## Хранение конфигураций {#hranenie-konfiguracij}
...
## Запуск статических групп {#zapusk-staticheskih-grupp}
