---
title: "Дисковая подсистема кластера aka YDB distributed storage"
url: "https://ydb.tech/docs/ru/contributor/distributed-storage?version=v26.1"
doc_path: "ru/contributor/distributed-storage"
version: "v26.1"
lang: "ru"
source_path: "ru/core/contributor/distributed-storage.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/contributor/distributed-storage.md"
description: "YDB distributed storage — это подсистема YDB, которая отвечает за надёжное хранение данных."
...
## Описание интерфейса distributed storage {#opisanie-interfejsa-distributed-storage}

### Формат идентификатора блоба {#format-identifikatora-bloba}
