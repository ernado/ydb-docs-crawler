---
title: "Обзор тестирования с помощью нагружающих акторов"
url: "https://ydb.tech/docs/ru/contributor/load-actors-overview?version=v26.1"
doc_path: "ru/contributor/load-actors-overview"
version: "v26.1"
lang: "ru"
...
Тестирование производительности системы является важным этапом добавления изменений в ядро YDB. С помощью [нагрузочного тестирования](https://ru.wikipedia.org/wiki/%D0%9D%D0%B0%D0%B3%D1%80%D1%83%D0%B7%D0%BE%D1%87%D0%BD%D0%BE%D0%B5_%D1%82%D0%B5%D1%81%D1%82%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5) вы можете:
...
> [!NOTE]
> Функциональность находится в разработке, исходный код доступен в ветке *main* [репозитория YDB](https://github.com/ydb-platform/ydb). О том, как собрать YDB из исходного кода, читайте в [инструкции](https://github.com/ydb-platform/ydb/blob/main/BUILD.md).
...
- Embedded UI
  ...
  2. Нажмите кнопку **Results**.
     ...
     ![load-actors-finished-tests](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/_assets/load-actors-finished-tests.png)
