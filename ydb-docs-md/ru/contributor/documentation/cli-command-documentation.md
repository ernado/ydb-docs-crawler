---
title: "Документирование новых команд CLI"
url: "https://ydb.tech/docs/ru/contributor/documentation/cli-command-documentation?version=v26.1"
doc_path: "ru/contributor/documentation/cli-command-documentation"
version: "v26.1"
lang: "ru"
...
## Общие принципы {#obshie-principy}

Перед началом работы над документацией новой команды:

1. Ознакомьтесь с [Руководство по стилю документации YDB](style-guide.md) для понимания общих правил стиля документации.
2. Убедитесь, что команда реализована и доступна в CLI с опцией `--help`.

## Структура статьи {#struktura-stati}

Каждая статья о команде CLI должна следовать следующей структуре:

### 1. Заголовок первого уровня {#1-zagolovok-pervogo-urovnya}
...
### 2. Краткое описание {#2-kratkoe-opisanie}
...
### 3. Примечания (опционально) {#3-primechaniya-opcionalno}
...
### 4. Общий вид команды {#4-obshij-vid-komandy}
...
### 5. Ссылка на справку {#5-ssylka-na-spravku}
...
### 6. Параметры подкоманды {#6-parametry-podkomandy}
...
## Полный шаблон статьи {#polnyj-shablon-stati}
...
## Специальные случаи {#specialnye-sluchai}

### Команды без параметров {#komandy-bez-parametrov}
...
### Команды с режимами работы {#komandy-s-rezhimami-raboty}
...
### Предупреждения об устаревших командах {#preduprezhdeniya-ob-ustarevshih-komandah}
...
## Именование файлов {#imenovanie-fajlov}
...
## Интеграция в документацию {#integraciya-v-dokumentaciyu}
...
## Проверка перед публикацией {#proverka-pered-publikaciej}
...
- [Руководство по стилю документации YDB](style-guide.md) — общее руководство по стилю документации
- [Структура документации YDB](structure.md) — структура документации
- [Процесс ревью документации YDB](review.md) — процесс ревью документации
