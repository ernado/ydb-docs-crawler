---
title: "LocalDB: персистентные незакомиченные изменения"
url: "https://ydb.tech/docs/ru/contributor/localdb-uncommitted-txs?version=v26.1"
doc_path: "ru/contributor/localdb-uncommitted-txs"
version: "v26.1"
lang: "ru"
...
## Запись незакомиченных изменений {#zapis-nezakomichennyh-izmenenij}
...
## Хранение незакомиченных изменений в MemTable {#hranenie-nezakomichennyh-izmenenij-v-memtable}
...
## Компакшен незакомиченных изменений {#kompakshen-nezakomichennyh-izmenenij}
...
## Статистика по незакомиченным транзакциям {#statistika-po-nezakomichennym-tranzakciyam}
...
## Одалживание SST с незакомиченными изменениями {#odalzhivanie-sst-s-nezakomichennymi-izmeneniyami}
