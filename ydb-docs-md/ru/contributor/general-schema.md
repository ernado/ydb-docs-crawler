---
title: "Общая схема YDB"
url: "https://ydb.tech/docs/ru/contributor/general-schema?version=v26.1"
doc_path: "ru/contributor/general-schema"
version: "v26.1"
lang: "ru"
...
Примерная общая схема YDB представлена ниже.

## Узлы {#nodes}

Одна инсталляция YDB состоит из *кластера*, который разбит на *узлы*. Узел — это один процесс в системе, как правило, ydbd. Этот узел входит в кластер и может обмениваться данными с другими узлами в этом кластере через *Interconnect*. Каждый *узел* имеет свой идентификатор, который обычно называется NodeId. NodeId — целое число от 1, состоящее из 20 бит. NodeId 0 зарезервирован для внутренних нужд и, как правило, обозначает текущий узел либо отсутствие узла.
...
Подробнее о блобах и распределённом хранилище можно прочитать в разделе [Дисковая подсистема кластера aka YDB distributed storage](distributed-storage.md).
