---
title: "Использование механизма TRANSFER для реализации SCD2 на основе данных из CDC-источников в YDB"
url: "https://ydb.tech/docs/ru/analyst/practical-guides/scd/scd2-transfer?version=v26.1"
doc_path: "ru/analyst/practical-guides/scd/scd2-transfer"
version: "v26.1"
lang: "ru"
source_path: "ru/core/analyst/practical-guides/scd/scd2-transfer.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/analyst/practical-guides/scd/scd2-transfer.md"
description: "В этой статье описывается реализация паттерна Slowly Changing Dimensions Type 2 (SCD2) в YDB. Используемые инструменты."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Использование механизма TRANSFER для реализации SCD2 на основе данных из CDC-источников в YDB

В этой статье описывается реализация паттерна Slowly Changing Dimensions Type 2 (SCD2) в YDB.

## Используемые инструменты {#ispolzuemye-instrumenty}
...
## Создайте таблицу-источник данных, которая будет генерировать CDC-события {#sozdajte-tablicu-istochnik-dannyh,-kotoraya-budet-generirovat-cdc-sobytiya}
...
## Создайте таблицу-приемник данных в формате SCD2 {#sozdajte-tablicu-priemnik-dannyh-v-formate-scd2}
...
## Создайте трансфер и lambda-функцию для обработки CDC-данных {#sozdajte-transfer-i-lambda-funkciyu-dlya-obrabotki-cdc-dannyh}
...
## Демонстрация работы {#demonstraciya-raboty}

Для демонстрации работы с данными CDC запишем данные в таблицу-источник в YDB, которая будет генерировать CDC-события:

### Вставка новой записи {#vstavka-novoj-zapisi}
...
| id | attribute1 | attribute2 | deleted_at | valid_from |
| --- | --- | --- | --- | --- |
| CUSTOMER_1001 | John Doe | New York | NULL | 2025-08-22T17:28:03.648313Z |

### Обновление новой записи {#obnovlenie-novoj-zapisi}
...
| --- | --- | --- | --- | --- |
| CUSTOMER_1001 | John Doe | New York | NULL | 2025-08-22T17:28:03.648313Z |
| CUSTOMER_1001 | John Doe 2 | New York 2 | NULL | 2025-08-22T17:31:18.357503Z |

### Удаление записи {#udalenie-zapisi}
...
| CUSTOMER_1001 | John Doe | New York | NULL | 2025-08-22T17:28:03.648313Z |
| CUSTOMER_1001 | John Doe 2 | New York 2 | NULL | 2025-08-22T17:31:18.357503Z |
| CUSTOMER_1001 | John Doe 2 | New York 2 | 2025-08-22T17:38:03.648313Z | 2025-08-22T17:38:03.648313Z |

### Пример запроса для получения актуальных данных {#primer-zaprosa-dlya-polucheniya-aktualnyh-dannyh}
