---
title: "Использование механизма TRANSFER для реализации SCD1 на основе данных из CDC-источников в YDB"
url: "https://ydb.tech/docs/ru/analyst/practical-guides/scd/scd1-transfer?version=v26.1"
doc_path: "ru/analyst/practical-guides/scd/scd1-transfer"
version: "v26.1"
lang: "ru"
...
Для поставки данных в SCD1-таблицу в данной статье будет использоваться следующая комбинация функциональных возможностей YDB:
...
>  Поэтому с помощью Transfer можно реализовать только SCD1-soft: удаление помечается флагом и сохраняется момент удаления. Если нужна физическая очистка данных, её можно выполнять через явную команду [`DELETE`](scd1-transfer.md#howtodelete).
...
## Создайте таблицу-приемник данных в формате SCD1 {#sozdajte-tablicu-priemnik-dannyh-v-formate-scd1}
...
| id | attribute1 | attribute2 | is_deleted | last_update_timestamp |
| --- | --- | --- | --- | --- |
| CUSTOMER_1001 | John Doe | New York | 0 | 2025-08-22T13:15:13.219000Z |

### Обновление существующей записи {#obnovlenie-sushestvuyushej-zapisi}
...
| id | attribute1 | attribute2 | is_deleted | last_update_timestamp |
| --- | --- | --- | --- | --- |
| CUSTOMER_1001 | John Doe | Los Angeles | 0 | 2025-08-22T13:19:55.719000Z |
...
| id | attribute1 | attribute2 | is_deleted | last_update_timestamp |
| --- | --- | --- | --- | --- |
| CUSTOMER_1001 | John Doe | Los Angeles | 1 | 2025-08-22T13:22:11.109000Z |
