---
title: "Векторный индекс — быстрый старт"
url: "https://ydb.tech/docs/ru/recipes/vector-search/vector-index-quickstart?version=v26.1"
doc_path: "ru/recipes/vector-search/vector-index-quickstart"
version: "v26.1"
lang: "ru"
source_path: "ru/core/recipes/vector-search/vector-index-quickstart.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/recipes/vector-search/vector-index-quickstart.md"
description: "Эта статья поможет быстро начать работу с векторными индексами в YDB на простейшем модельном примере."
...
- [создание таблицы с векторами](vector-index-quickstart.md#step1);
- [заполнение таблицы данными](vector-index-quickstart.md#step2);
- [построение векторного индекса](vector-index-quickstart.md#step3);
- [выполнение векторного поиска без индекса](vector-index-quickstart.md#step4);
- [выполнение векторного поиска с индексом](vector-index-quickstart.md#step5).
...
Общую информацию о векторных индексах, параметрах их создания и текущих ограничениях см. в разделе [Векторные индексы](../../dev/vector-indexes.md).
...
Сначала целевой вектор кодируется в бинарное представление с помощью [`Knn::ToBinaryStringFloat`](../../yql/reference/udf/list/knn.md#functions-convert).
...
Для поиска 3-х ближайших соседей вектора `[1.f, 1.f, 1.f, 1.f, 4.f]` с использованием индекса `EmbeddingIndex`, который был создан на [шаге 3](vector-index-quickstart.md#step3), нужно выполнить запрос:
