...
url: "https://ydb.tech/docs/ru/recipes/ydb-sdk/vector-search?version=v26.1"
doc_path: "ru/recipes/ydb-sdk/vector-search"
version: "v26.1"
lang: "ru"
...
В данном разделе содержатся рецепты кода на разных языках программирования для решения задач [векторного поиска](../../concepts/query_execution/vector_search.md) с использованием YDB SDK.

Подробно будут разобраны операции:

- [Векторный поиск](vector-search.md#векторный-поиск)

  - [Подключение к YDB](vector-search.md#connect-ydb)
  - [Создание таблицы](vector-search.md#create-table)
  - [Вставка векторов](vector-search.md#insert-vectors)
  - [Добавление индекса](vector-search.md#add-vector-index)
  - [Поиск по вектору](vector-search.md#search-by-vector)
  - [Итоговый пример](vector-search.md#full-example)
...
- C++
  ...
  - Рекомендуемый способ
    ...
    > [!NOTE]
    > В функции `ConvertVectorToBytes` подразумевается, что на клиенте используется процессор с [little-endian порядком байт](https://ru.wikipedia.org/wiki/%D0%9F%D0%BE%D1%80%D1%8F%D0%B4%D0%BE%D0%BA_%D0%B1%D0%B0%D0%B9%D1%82%D0%BE%D0%B2), например x86_64. Если используется другой порядок байт, функцию `ConvertVectorToBytes` необходимо адаптировать.
