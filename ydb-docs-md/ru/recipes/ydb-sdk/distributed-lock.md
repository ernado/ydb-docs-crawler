...
url: "https://ydb.tech/docs/ru/recipes/ydb-sdk/distributed-lock?version=v26.1"
doc_path: "ru/recipes/ydb-sdk/distributed-lock"
version: "v26.1"
lang: "ru"
source_path: "ru/core/recipes/ydb-sdk/distributed-lock.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/recipes/ydb-sdk/distributed-lock.md"
description: "Рассмотрим сценарий, где необходимо обеспечить, чтобы с разделяемым ресурсом в один момент времени работал только один экземпляр клиентского приложения. Для его"
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Распределённая блокировка

Рассмотрим сценарий, где необходимо обеспечить, чтобы с разделяемым ресурсом в один момент времени работал только один экземпляр клиентского приложения. Для его реализации можно воспользоваться механизмом семафоров в [узлах координации YDB](../../reference/ydb-sdk/coordination.md).

## Механизм аренды семафоров {#mehanizm-arendy-semaforov}
