---
title: "Пакетная вставка данных"
url: "https://ydb.tech/docs/ru/recipes/ydb-sdk/bulk-upsert?version=v26.1"
doc_path: "ru/recipes/ydb-sdk/bulk-upsert"
version: "v26.1"
lang: "ru"
source_path: "ru/core/recipes/ydb-sdk/bulk-upsert.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/recipes/ydb-sdk/bulk-upsert.md"
description: "YDB поддерживает пакетную вставку большого количества строк без гарантий атомарности. Запись данных разбивается на несколько независимых транзакций, каждая их к"
...
- Go
  ...
  - Native SDK
    ...
    <details>
    <summary>Пакетная вставка нативных YDB данных</summary>
    ...
    <details>
    <summary>Пакетная вставка `CSV`</summary>
    ...
    <details>
    <summary>Пакетная вставка `Apache Arrow`</summary>
