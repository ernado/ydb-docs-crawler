---
title: "Выполнение повторных попыток"
url: "https://ydb.tech/docs/ru/recipes/ydb-sdk/retry?version=v26.1"
doc_path: "ru/recipes/ydb-sdk/retry"
version: "v26.1"
lang: "ru"
source_path: "ru/core/recipes/ydb-sdk/retry.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/recipes/ydb-sdk/retry.md"
description: "YDB является распределенной СУБД с автоматическим масштабированием под нагрузку."
...
- C++
  ...
  - Native SDK
    ...
    <details>
    <summary>Синхронное выполнение повторных попыток</summary>
    ...
    <details>
    <summary>Асинхронное выполнение повторных попыток</summary>
    ...
    <details>
    <summary>Выполнение повторных попыток при работе со стриминговыми запросами</summary>
    ...
    <details>
    <summary>Настройка параметров повторных попыток</summary>
...
- Go
  ...
  - Native SDK
    ...
    <details>
    <summary>Функция повторов общего назначения</summary>
    ...
    <details>
    <summary>Выполнение повторных попыток при ошибках на объекте сессии YDB</summary>
    ...
    <details>
    <summary>Выполнение повторных попыток при ошибках на объекте интерактивной транзакции YDB</summary>
    ...
    <details>
    <summary>Запросы к остальным сервисам YDB</summary>
  ...
  - database/sql
    ...
    <details>
    <summary>Выполнение повторных попыток при ошибках на объекте соединения `*sql.Conn`:</summary>
    ...
    <details>
    <summary>Выполнение повторных попыток при ошибках на объекте интерактивной транзакции `*sql.Tx`:</summary>
...
- Java
  ...
  - Native SDK
    ...
    - В рамках исполнения лямбды была вызвано `UnexpectedResultException` c [retryable](../../reference/ydb-sdk/error_handling.md) кодом ошибки
      ...
      <details>
      <summary>Пример кода, использующего SessionRetryContext.supplyStatus:</summary>
      ...
      <details>
      <summary>Пример кода, использующего SessionRetryContext.supplyResult:</summary>
...
- C#
  ...
  В YDB C# SDK повторные попытки реализованы на двух уровнях.
...
- PHP
  ...
  В YDB PHP SDK повторные попытки для запросов к Table API задаются через `Table::retryTransaction()` (транзакция + коммит + ретраи при поддерживаемых ошибках) или `Table::retrySession()` (одна сессия без обёртки «транзакция целиком»). Второй аргумент `retryTransaction` — признак идемпотентности (`true` расширяет набор ошибок, при которых выполняется повтор).
