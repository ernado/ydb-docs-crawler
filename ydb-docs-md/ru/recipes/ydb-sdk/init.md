---
title: "Инициализация драйвера"
url: "https://ydb.tech/docs/ru/recipes/ydb-sdk/init?version=v26.1"
doc_path: "ru/recipes/ydb-sdk/init"
version: "v26.1"
lang: "ru"
source_path: "ru/core/recipes/ydb-sdk/init.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/recipes/ydb-sdk/init.md"
description: "Для подключения к YDB требуется указать обязательные параметры (подробнее читайте в разделе Подключение к серверу YDB ) и дополнительные, которые определяют пов"
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Инициализация драйвера

Для подключения к YDB требуется указать обязательные параметры (подробнее читайте в разделе [Подключение к серверу YDB](../../concepts/connect.md)) и дополнительные, которые определяют поведение драйвера при работе.
...
- Go
  ...
  - database/sql
    ...
    <details>
    <summary>С помощью коннектора (рекомендуемый способ)</summary>
    ...
    <details>
    <summary>С помощью строки подключения</summary>
