---
title: "Установка режима выполнения транзакции"
url: "https://ydb.tech/docs/ru/recipes/ydb-sdk/tx-control?version=v26.1"
doc_path: "ru/recipes/ydb-sdk/tx-control"
version: "v26.1"
lang: "ru"
source_path: "ru/core/recipes/ydb-sdk/tx-control.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/recipes/ydb-sdk/tx-control.md"
description: "Для выполнения запросов в YDB SDK необходимо указывать режим выполнения транзакции."
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Установка режима выполнения транзакции

Для выполнения запросов в YDB SDK необходимо указывать [режим выполнения транзакции](../../concepts/transactions.md#modes).
...
[ImplicitTx](../../concepts/transactions.md#implicit) режим позволяет выполнить один запрос без явного управления транзакцией. Запрос выполняется в своей собственной неявной транзакции, которая автоматически фиксируется в случае успеха.
