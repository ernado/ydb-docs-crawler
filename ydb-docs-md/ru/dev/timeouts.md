---
title: "Использование таймаутов"
url: "https://ydb.tech/docs/ru/dev/timeouts?version=v26.1"
doc_path: "ru/dev/timeouts"
version: "v26.1"
lang: "ru"
source_path: "ru/core/dev/timeouts.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/dev/timeouts.md"
description: "В разделе приведено описание доступных таймаутов и представлены примеры использования на различных языках программирования."
...
Механизм таймаутов в YDB призван решить следующие проблемы:
...
>
> Например, можно использовать удвоенное значение 99-го перцентиля времени ответа. Иными словами, таймаут должен равняться 2×P992 × P992×P99
>
