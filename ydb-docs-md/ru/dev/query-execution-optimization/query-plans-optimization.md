---
title: "Использование планов при оптимизации запросов"
url: "https://ydb.tech/docs/ru/dev/query-execution-optimization/query-plans-optimization?version=v26.1"
doc_path: "ru/dev/query-execution-optimization/query-plans-optimization"
version: "v26.1"
lang: "ru"
...
## План исполнения запроса {#plan-ispolneniya-zaprosa}
...
![episodes](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/_assets/episodes_scheme.png)

Построим план исполнения для данного запроса, в YDB это можно сделать двумя способами:

{% list tabs %}

- YDB CLI

  Получить план запроса через YDB [CLI](../../reference/ydb-cli/commands/explain-plan.md) можно с помощью следующей команды:
...
- Embedded UI
  ...
  ![explain_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/_assets/explain_ui.png)

  Результат:

  ![query_plan_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/_assets/query_plan_ui.png)
...
- Embedded UI
  ...
  ![explain_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/_assets/explain_with_index_ui.png)

  Результат:

  ![query_plan_ui](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/_assets/query_plan_with_index_ui.png)
