---
title: "Системные представления базы данных"
url: "https://ydb.tech/docs/ru/dev/system-views?version=v26.1"
doc_path: "ru/dev/system-views"
version: "v26.1"
lang: "ru"
...
| `ResourceWeight` | [Веса](resource-consumption-management.md#resources_weight) для распределения ресурсов между пулами.  <br>Тип: `Double`. |
...
Представление `auth_users` содержит список локальных [пользователей](../concepts/glossary.md#access-user) YDB. В него не входят пользователи, аутентифицированные через внешние системы, такие как LDAP.
...
### Информация о группах {#informaciya-o-gruppah}
...
### Информация о членстве в группах {#informaciya-o-chlenstve-v-gruppah}
...
### Информация о правах доступа {#informaciya-o-pravah-dostupa}
...
| `Permission` | Название [права доступа](../yql/reference/syntax/grant.md#permissions-list) YDB.  <br>Тип: `Utf8`.  <br>Ключ: `2`. |

#### Примеры запросов {#primery-zaprosov}
