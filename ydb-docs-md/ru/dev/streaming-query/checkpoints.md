---
title: "Чекпоинты"
url: "https://ydb.tech/docs/ru/dev/streaming-query/checkpoints?version=v26.1"
doc_path: "ru/dev/streaming-query/checkpoints"
version: "v26.1"
lang: "ru"
...
Чекпоинт — это сохранённое состояние работающего [потокового запроса](../../concepts/streaming-query/streaming-query.md), необходимое для восстановления после сбоев обработки. YDB периодически сохраняет чекпоинты всех запущенных потоковых запросов.
...
События, поступившие между последним чекпоинтом и моментом сбоя, будут обработаны повторно. Это обеспечивает гарантию [at-least-once](guarantees.md#at-least-once) — каждое событие будет обработано минимум один раз.
...
Подробнее о влиянии этого поведения на гарантии доставки — в разделе [Потеря событий при пересоздании запроса](guarantees.md#incomplete-windows-restart).
...
- [Гарантии доставки данных](guarantees.md) — гарантии доставки данных и наблюдаемые аномалии.
