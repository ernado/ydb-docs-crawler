...
url: "https://ydb.tech/docs/ru/dev/streaming-query/enrichment?version=v26.1"
doc_path: "ru/dev/streaming-query/enrichment"
version: "v26.1"
lang: "ru"
...
## Подготовка источника данных для работы с топиками {#podgotovka-istochnika-dannyh-dlya-raboty-s-topikami}
...
## Потоковые запросы для обогащения данных {#potokovye-zaprosy-dlya-obogasheniya-dannyh}
...
Подробнее о форматах данных (`json_each_row`, `csv_with_names` и др.): [Форматы данных при чтении/записи из топиков](streaming-query-formats.md).
