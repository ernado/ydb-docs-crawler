---
title: "Типичные шаблоны потоковых запросов"
url: "https://ydb.tech/docs/ru/dev/streaming-query/patterns?version=v26.1"
doc_path: "ru/dev/streaming-query/patterns"
version: "v26.1"
lang: "ru"
...
Подробнее о форматах: [Форматы данных при чтении/записи из топиков](streaming-query-formats.md).
...
Подробнее о форматах записи: [Форматы при записи данных](streaming-query-formats.md#write_formats).
...
Подробнее: [Запись в таблицы](table-writing.md).

## См. также {#sm-takzhe}

- [CREATE STREAMING QUERY](../../yql/reference/syntax/create-streaming-query.md)
- [Быстрый старт: чтение и запись в топики](../../recipes/streaming_queries/topics.md)
