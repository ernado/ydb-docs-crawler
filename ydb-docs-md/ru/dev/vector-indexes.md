---
title: "Векторные индексы"
url: "https://ydb.tech/docs/ru/dev/vector-indexes?version=v26.1"
doc_path: "ru/dev/vector-indexes"
version: "v26.1"
lang: "ru"
source_path: "ru/core/dev/vector-indexes.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/dev/vector-indexes.md"
description: "Векторные индексы — это специализированные структуры данных, которые позволяют эффективно выполнять векторный поиск в многомерных пространствах. В отличие от вт"
...
Векторные индексы в YDB решают задачу поиска ближайших соседей с использованием [функций схожести или расстояния](../yql/reference/udf/list/knn.md#functions-distance). Параметры функций расстояния/схожести для векторных индексов:
