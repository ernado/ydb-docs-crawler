---
title: "Выбор ключей для максимальной производительности колоночных таблиц"
url: "https://ydb.tech/docs/ru/dev/primary-key/column-oriented?version=v26.1"
doc_path: "ru/dev/primary-key/column-oriented"
version: "v26.1"
lang: "ru"
...
## Ключ партиционирования {#klyuch-particionirovaniya}
...
## Первичный ключ {#pervichnyj-klyuch}
...
### Выбор ключа партиционирования {#vybor-klyucha-particionirovaniya}
...
### Выбор первичного ключа {#vybor-pervichnogo-klyucha}
