---
title: "CREATE STREAMING QUERY"
url: "https://ydb.tech/docs/ru/yql/reference/syntax/create-streaming-query?version=v26.1"
doc_path: "ru/yql/reference/syntax/create-streaming-query"
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/reference/syntax/create-streaming-query.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/reference/syntax/create-streaming-query.md"
description: "CREATE STREAMING QUERY создаёт потоковый запрос. Синтаксис."
...
- `AS DO BEGIN ... END DO` — полный текст нового потокового запроса, включая все необходимые SQL-выражения. Ограничения для текста запроса приведены в [Ограничения](../../../concepts/streaming-query/streaming-query.md#limitations), примеры текста [см. ниже](create-streaming-query.md#examples).
...
Примеры создания потокового запроса [см. ниже](create-streaming-query.md#examples).
...
Другие примеры: [Типичные шаблоны потоковых запросов](../../../dev/streaming-query/patterns.md).

## См. также {#sm-takzhe}

- [Типичные шаблоны потоковых запросов](../../../dev/streaming-query/patterns.md)
