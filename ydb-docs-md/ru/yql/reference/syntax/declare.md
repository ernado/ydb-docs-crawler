---
title: "DECLARE"
url: "https://ydb.tech/docs/ru/yql/reference/syntax/declare?version=v26.1"
doc_path: "ru/yql/reference/syntax/declare"
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/reference/syntax/declare.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/reference/syntax/declare.md"
description: "Объявляет типизированное именованное выражение, значение для которого будет передано параметром отдельно от текста запроса. Параметризация дает возможность отде"
...
3. Ключевое слово `AS`.
4. `data_type` — тип данных [в виде строки в принятом формате](../types/type_string.md).
