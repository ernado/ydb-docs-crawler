...
url: "https://ydb.tech/docs/ru/yql/reference/syntax/create-external-data-source?version=v26.1"
doc_path: "ru/yql/reference/syntax/create-external-data-source"
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/reference/syntax/create-external-data-source.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/reference/syntax/create-external-data-source.md"
description: "Вызов CREATE EXTERNAL DATA SOURCE создает внешний источник данных."
...
- `source_type` - тип внешнего источника данных. Возможные значения: [`ClickHouse`](create-external-data-source.md#clickhouse), [`PostgreSQL`](create-external-data-source.md#postgresql), [`ObjectStorage`](create-external-data-source.md#object_storage).
...
В данный момент подключение к кластеру PostgreSQL всегда выполняется про стандартному ([Frontend/Backend Protocol](https://www.postgresql.org/docs/current/protocol.html)) по транспорту TCP. При работе по защищенным TLS каналам связи используется системные сертификаты, расположенные на серверах YDB.
...
## Подключение к S3 (Object Storage) {#object_storage}
