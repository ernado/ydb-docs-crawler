...
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/reference/types/cast.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/reference/types/cast.md"
description: "Правила преобразования примитивных типов данных."
...
## Правила преобразований для контейнеров {#pravila-preobrazovanij-dlya-kontejnerov}

### Правила для Optional {#pravila-dlya-optional}
...
### Правила для List/Dict {#pravila-dlya-list/dict}
...
### Правила для Struct/Tuple {#pravila-dlya-struct/tuple}
...
### Правила для Variant {#pravila-dlya-variant}
...
### Вложенные контейнеры {#vlozhennye-kontejnery}
