---
title: "ru/yql/reference/types/optional"
url: "https://ydb.tech/docs/ru/yql/reference/types/optional?version=v26.1"
doc_path: "ru/yql/reference/types/optional"
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/reference/types/optional.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/reference/types/optional.md"
description: "Типы данных, допускающие значение NULL."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# ru/yql/reference/types/optional

## Типы данных, допускающие значение NULL {#tipy-dannyh,-dopuskayushie-znachenie-null}
...
- [JUST](../builtins/basic.md#optional-ops) — добавить опциональность к текущему типу, `T` преобразуется в `T?`
...
Создать non-nullable колонку в таблице YDB можно с помощью операции [CREATE TABLE](../syntax/create_table/index.md), пользуясь ключевым словом `NOT NULL`.
...
### Пример взаимодействия NOT NULL ограничения с функциями YQL {#primer-vzaimodejstviya-not-null-ogranicheniya-s-funkciyami-yql}
