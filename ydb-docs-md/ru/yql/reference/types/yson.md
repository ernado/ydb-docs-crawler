---
title: "Yson"
url: "https://ydb.tech/docs/ru/yql/reference/types/yson?version=v26.1"
doc_path: "ru/yql/reference/types/yson"
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/reference/types/yson.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/reference/types/yson.md"
description: "В данном разделе собрана информация про YSON — JSON-подобный формат данных, разработанный в Яндексе. Примечание. SQL-функции для работы с YSON описаны здесь."
...
2. [Атрибуты](yson.md#attributes): произвольный словарь, который можно установить дополнительно на литерал любого (даже скалярного) типа.
...
1. [Строки](yson.md#string) (`string`);
2. [Знаковые](yson.md#int) и [беззнаковые](yson.md#uint) 64-битные целые числа (`int64` и `uint64` );
3. [Числа с плавающей точкой](yson.md#double) двойной точности (`double`);
4. [Булев](yson.md#boolean) (логический) тип (`boolean`);
5. [Специальный тип entity](yson.md#entity), имеющий всего один литерал (`#`).

Скалярные типы обычно имеют как текстовое, так и бинарное представление.

Есть два **композитных** типа:

1. [Список](yson.md#list) (`list`);
2. [Словарь](yson.md#map) (`map`).
...
Не все эти символы используются в YSON, некоторые используются в [YPath](yson.md#ypath).
