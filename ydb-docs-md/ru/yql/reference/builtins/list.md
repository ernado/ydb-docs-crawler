...
url: "https://ydb.tech/docs/ru/yql/reference/builtins/list?version=v26.1"
doc_path: "ru/yql/reference/builtins/list"
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/reference/builtins/list.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/reference/builtins/list.md"
...
> [!NOTE]
> В `ListFlatMap` использование опциональных значений в результатах функции является устаревшим, вместо этого следует использовать комбинацию [`ListNotNull`](list.md#listnotnull) и `ListMap`.
