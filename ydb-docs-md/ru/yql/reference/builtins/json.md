---
title: "Функции для работы с JSON"
url: "https://ydb.tech/docs/ru/yql/reference/builtins/json?version=v26.1"
doc_path: "ru/yql/reference/builtins/json"
version: "v26.1"
lang: "ru"
...
### Обращение к полю в базе данных {#obrashenie-k-polyu-v-baze-dannyh}
...
### Режим выполнения {#rezhim-vypolneniya}
...
#### Автоматическая распаковка массива {#avtomaticheskaya-raspakovka-massiva}
...
#### Обертка в массив {#obertka-v-massiv}
...
### Обращение к ключу JSON объекта {#obrashenie-k-klyuchu-json-obuekta}
...
### Обращение ко всем ключам JSON объекта {#obrashenie-ko-vsem-klyucham-json-obuekta}
...
### Обращение к элементу массива {#obrashenie-k-elementu-massiva}
...
### Обращение ко всем элементам массива {#obrashenie-ko-vsem-elementam-massiva}
...
#### Унарные операции {#unarnye-operacii}
...
#### Бинарные операции {#binarnye-operacii}
...
### Булевские значения {#bulevskie-znacheniya}
...
#### Логическое отрицание ! {#logicheskoe-otricanie}
...
#### Логическое И && {#logicheskoe-i-andand}
...
#### Логическое ИЛИ || {#logicheskoe-ili-oror}
...
### Операторы сравнения {#operatory-sravneniya}
...
## Общие аргументы {#obshie-argumenty}
...
### PASSING секция {#passing-sekciya}
