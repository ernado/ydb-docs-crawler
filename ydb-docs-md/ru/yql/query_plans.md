---
title: "Структура планов запросов"
url: "https://ydb.tech/docs/ru/yql/query_plans?version=v26.1"
doc_path: "ru/yql/query_plans"
version: "v26.1"
lang: "ru"
source_path: "ru/core/yql/query_plans.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/yql/query_plans.md"
description: "Чтобы лучше понимать работу запроса, вы можете получить и проанализировать его план."
...
![stage](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/yql/_assets/stage.png)
...
Итератор по заданному набору строк, как правило в качестве аргумента принимает [precompute](query_plans.md#precompute).

#### PartitionByKey

Партиционирование по ключу, как правило в качестве аргумента принимает [precompute](query_plans.md#precompute).
...
![connection](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/yql/_assets/connection.png)
...
![resultset](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/yql/_assets/resultset.png)
...
![precompute](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/yql/_assets/precompute.png)
