---
title: "Логирование TLI"
url: "https://ydb.tech/docs/ru/troubleshooting/performance/queries/tli-logging?version=v26.1"
doc_path: "ru/troubleshooting/performance/queries/tli-logging"
version: "v26.1"
lang: "ru"
source_path: "ru/core/troubleshooting/performance/queries/tli-logging.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/troubleshooting/performance/queries/tli-logging.md"
description: "Логирование инвалидации блокировок транзакций (TLI) позволяет установить, у какого запроса были сломаны блокировки (жертва) и какой запрос их сломал (нарушитель"
...
## Включение логирования {#vklyuchenie-logirovaniya}
...
## Структура логов {#struktura-logov}
...
## Утилита find_tli_chain {#utilita-find_tli_chain}

Для автоматического анализа логов TLI в репозитории YDB есть утилита [find_tli_chain.py](https://github.com/ydb-platform/ydb/tree/main/ydb/tools/tli_analysis).
