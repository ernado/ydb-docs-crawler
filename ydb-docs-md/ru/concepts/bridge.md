---
title: "Режим работы кластера Bridge"
url: "https://ydb.tech/docs/ru/concepts/bridge?version=v26.1"
doc_path: "ru/concepts/bridge"
version: "v26.1"
lang: "ru"
...
Для хранения данных используются пары [групп хранения](glossary.md#storage-group) из разных pile. При этом для хранения данных в каждом из pile могут применяться любые поддерживаемые YDB [режимы работы](topology.md#cluster-config).
...
### Нештатное восстановление pile {#neshtatnoe-vosstanovlenie-pile}
...
Подробнее об устройстве режима bridge см. в [Устройство режима bridge](../contributor/bridge.md).
