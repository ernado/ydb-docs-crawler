---
title: "Коллекция резервных копий"
url: "https://ydb.tech/docs/ru/concepts/datamodel/backup-collection?version=v26.1"
doc_path: "ru/concepts/datamodel/backup-collection"
version: "v26.1"
lang: "ru"
...
## Ключевые концепции {#klyuchevye-koncepcii}
...
### Как работают коллекции резервных копий {#kak-rabotayut-kollekcii-rezervnyh-kopij}
...
#### Кластерное хранилище {#klasternoe-hranilishe}
...
### Фоновые операции {#fonovye-operacii}
...
## Восстановление из резервных копий {#vosstanovlenie-iz-rezervnyh-kopij}
...
### Процесс восстановления {#process-vosstanovleniya}
...
- [Концепции резервного копирования](../backup.md): Обзор всех подходов к резервному копированию в YDB
