...
url: "https://ydb.tech/docs/ru/concepts/datamodel/view?version=v26.1"
doc_path: "ru/concepts/datamodel/view"
version: "v26.1"
lang: "ru"
...
## Инвалидация представления {#invalidaciya-predstavleniya}
...
## Время выполнения запросов, читающих из представления {#vremya-vypolneniya-zaprosov,-chitayushih-iz-predstavleniya}
...
## Транзакционность переопределения представления {#tranzakcionnost-pereopredeleniya-predstavleniya}
...
### Кэш результатов компиляции {#kesh-rezultatov-kompilyacii}
...
### Описание проблемы {#opisanie-problemy}
