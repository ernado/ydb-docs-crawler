---
title: "Обзор"
url: "https://ydb.tech/docs/ru/concepts/analytics/?version=v26.1"
doc_path: "ru/concepts/analytics/"
version: "v26.1"
lang: "ru"
source_path: "ru/core/concepts/analytics/index.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/concepts/analytics/index.md"
description: "YDB — это распределённая отказоустойчивая база данных, которая предоставляет компоненты для построения корпоративного хранилища данных (КХД) на единой платформе"
...
![](https://raw.githubusercontent.com/ydb-platform/ydb/main/ydb/docs/ru/core/concepts/analytics/_includes/olap_whole.png)
...
Основа хранилища — [колоночные таблицы](../datamodel/table.md#column-oriented-tables) со встроенным сжатием, оптимизированные для аналитических нагрузок.
