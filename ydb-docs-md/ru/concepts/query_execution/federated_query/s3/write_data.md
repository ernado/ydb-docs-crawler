---
title: "Запись данных в бакеты S3"
url: "https://ydb.tech/docs/ru/concepts/query_execution/federated_query/s3/write_data?version=v26.1"
doc_path: "ru/concepts/query_execution/federated_query/s3/write_data"
version: "v26.1"
lang: "ru"
source_path: "ru/core/concepts/query_execution/federated_query/s3/write_data.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/concepts/query_execution/federated_query/s3/write_data.md"
description: "В YDB для записи данных в бакет S3 можно использовать внешние источники данных или внешние таблицы. Запись в S3 через внешний источник данных."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Запись данных в бакеты S3

В YDB для записи данных в бакет S3 можно использовать [внешние источники данных](write_data.md#external-source-write) или [внешние таблицы](write_data.md#external-table-write).
...
YDB поддерживает экспорт данных из таблиц в S3 с помощью [внешнего источника данных](../../../datamodel/external_data_source.md).

Для экспорта необходимо использовать запрос [записи во внешний источник данных](write_data.md#external-source-write) с указанием [формата экспортируемых файлов](formats.md#formats):
...
Экспортировать можно как обычные YDB [таблицы](../../../datamodel/table.md), так и любые [внешние таблицы](../../../datamodel/external_table.md).

> [!TIP]
> Рекомендованным форматом экспорта является `parquet`, для него оптимизированы сценарии импорта и экспорта.

Для экспорта в S3-совместимое хранилище данных всех таблиц, расположенных в определённой директории в схеме данных, а также информации о расположении таблиц, директорий и индексов таблиц, нужно использовать YDB CLI. Подробнее см. в статье [Выгрузка в S3-совместимое хранилище](../../../../reference/ydb-cli/export-import/export-s3.md).
