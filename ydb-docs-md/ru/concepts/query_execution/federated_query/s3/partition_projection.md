---
title: "Расширенное партицирование"
url: "https://ydb.tech/docs/ru/concepts/query_execution/federated_query/s3/partition_projection?version=v26.1"
doc_path: "ru/concepts/query_execution/federated_query/s3/partition_projection"
version: "v26.1"
lang: "ru"
source_path: "ru/core/concepts/query_execution/federated_query/s3/partition_projection.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/concepts/query_execution/federated_query/s3/partition_projection.md"
description: "Партицирование позволяет подсказать для YDB правила размещения данных в S3-совместимом хранилище данных."
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Расширенное партицирование

[Партицирование](partitioning.md) позволяет подсказать для YDB правила размещения данных в S3-совместимом хранилище данных.
...
Используется для колонок, чьи значения можно представить в виде целых чисел диапазона 2<sup>-63</sup> до 2<sup>63</sup>-1.
...
## Работа с макроподстановкой NOW {#rabota-s-makropodstanovkoj-now}
...
2. Допустимые размерности интервалов: YEARS, MONTHS, WEEKS, DAYS, HOURS, MINUTES, SECONDS, MILLISECONDS.

3. В выражениях возможно использовать только одно арифметическое действие, выражения вида `NOW-5MINUTES+6SECONDS` не поддерживаются.

4. Работа с интервалами всегда приводит к получению корректной даты, но в зависимости от размерности, итоговые результаты могут быть разными:
