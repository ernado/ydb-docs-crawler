...
В графе этого запроса все таблицы `Dim...` соединяются c таблицей фактов `Fact_Sales`:  
 ![Граф запроса](https://ydb.tech/docs/docs-assets/ydb-platform--ydb/rev/a6ee1837f90009a183281888dccad12a7b30d774/ru/concepts/query_execution/_assets/Star-Schema.png)
