---
title: "Спиллинг"
url: "https://ydb.tech/docs/ru/concepts/query_execution/spilling?version=v26.1"
doc_path: "ru/concepts/query_execution/spilling"
version: "v26.1"
lang: "ru"
source_path: "ru/core/concepts/query_execution/spilling.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/concepts/query_execution/spilling.md"
description: "Спиллинг в общем."
revision: "e9f541853a7760e5c0d0babc071d86df7f523cf5"
---

# Спиллинг

## Спиллинг в общем {#spilling-v-obshem}
...
## Спиллинг в YDB {#architecture}

YDB реализует механизм спиллинга через **Spilling Service** — [акторный сервис](../glossary.md#actor-service), который предоставляет временное хранилище для блобов данных. Спиллинг осуществляется только на [узлах базы данных](../glossary.md#database-node). Подробная техническая информация о Spilling Service доступна в разделе [Spilling Service](../../contributor/spilling-service.md).

### Типы спиллинга в YDB {#tipy-spillinga-v-ydb}

YDB реализует два основных типа спиллинга, функционирующие на различных уровнях вычислительного процесса:

- [Спиллинг в вычислениях](spilling.md#computation-spilling)
- [Спиллинг в транспорте](spilling.md#transport-spilling)
...
##### Механизм функционирования {#mehanizm-funkcionirovaniya}
...
##### Механизм функционирования {#mehanizm-funkcionirovaniya1}
