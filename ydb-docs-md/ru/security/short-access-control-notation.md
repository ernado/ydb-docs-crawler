---
title: "Краткая запись управления доступом"
url: "https://ydb.tech/docs/ru/security/short-access-control-notation?version=v26.1"
doc_path: "ru/security/short-access-control-notation"
version: "v26.1"
lang: "ru"
source_path: "ru/core/security/short-access-control-notation.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/security/short-access-control-notation.md"
description: "При описании или логировании разрешений, которые выдаются пользователям (например при записи аудитных логов ), может использоваться специальная краткая запись у"
...
## Формат записи {#format-zapisi}

Каждая запись начинается со знака `+` и состоит из 2 или 3 атрибутов, перечисленных через символ `:`.

Эти атрибуты:

- [список разрешений](short-access-control-notation.md#access-rights). Обязательный.
- SID субъекта предоставленных разрешений. Обязательный.
- [тип наследования](short-access-control-notation.md#inheritance-types). Необязательный.
...
### Группы разрешений {#gruppy-razreshenij}
...
### Простые разрешения {#prostye-razresheniya}
