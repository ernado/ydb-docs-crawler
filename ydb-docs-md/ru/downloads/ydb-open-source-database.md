---
title: "Загрузка YDB Open-Source Database"
url: "https://ydb.tech/docs/ru/downloads/ydb-open-source-database?version=v26.1"
doc_path: "ru/downloads/ydb-open-source-database"
version: "v26.1"
lang: "ru"
source_path: "ru/core/downloads/ydb-open-source-database.md"
vcs_url: "https://github.com/ydb-platform/ydb/tree/main/ydb/docs/ru/core/downloads/ydb-open-source-database.md"
description: "YDB Open-Source Database ( ydbd ) — исполняемый файл для запуска узла кластера YDB. Распространяется под лицензией Apache 2.0."
revision: "95f7629e80402dd261127ed00cdc781d2b8433de"
---

# Загрузка YDB Open-Source Database

YDB Open-Source Database (`ydbd`) — исполняемый файл для запуска узла [кластера YDB](../concepts/glossary.md#cluster). Распространяется под [лицензией Apache 2.0](https://github.com/ydb-platform/ydb/blob/main/LICENSE).

См. также [Загрузка Корпоративной СУБД Яндекса (Yandex Enterprise Database)](yandex-enterprise-database.md).
